...
pub type Gfc6R = crate::BitReader;
#[doc = "Field `GFC6` writer - Channel 6 Global flag clear"]
pub type Gfc6W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type Gfc7R = crate::BitReader;
#[doc = "Field `GFC7` writer - Channel 7 Global flag clear"]
pub type Gfc7W<'a, REG> = crate::BitWriter<'a, REG>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn gfc1(&mut self) -> Gfc1W<ClrSpec> {
        Gfc1W::new(self, 0)
    }
    #[doc = "Bit 1 - Channel 1 full data transfer flag clear"]
    #[inline(always)]
    #[must_use]
    pub fn fdtfc1(&mut self) -> Fdtfc1W<ClrSpec> {
        Fdtfc1W::new(self, 1)
    }
    #[doc = "Bit 2 - Channel 1 half data transfer flag clear"]
    #[inline(always)]
    #[must_use]
    pub fn hdtfc1(&mut self) -> Hdtfc1W<ClrSpec> {
        Hdtfc1W::new(self, 2)
    }
    #[doc = "Bit 3 - Channel 1 data transfer error flag clear"]
    #[inline(always)]
    #[must_use]
    pub fn dterrfc1(&mut self) -> Dterrfc1W<ClrSpec> {
        Dterrfc1W::new(self, 3)
    }
    #[doc = "Bit 4 - Channel 2 Global flag clear"]
    #[inline(always)]
    #[must_use]
    pub fn gfc2(&mut self) -> Gfc2W<ClrSpec> {
        Gfc2W::new(self, 4)
    }
    #[doc = "Bit 5 - Channel 2 full data transfer flag clear"]
    #[inline(always)]
    #[must_use]
    pub fn fdtfc2(&mut self) -> Fdtfc2W<ClrSpec> {
        Fdtfc2W::new(self, 5)
    }
    #[doc = "Bit 6 - Channel 2 half data transfer flag clear"]
    #[inline(always)]
    #[must_use]
    pub fn hdtfc2(&mut self) -> Hdtfc2W<ClrSpec> {
        Hdtfc2W::new(self, 6)
    }
    #[doc = "Bit 7 - Channel 2 data transfer error flag clear"]
    #[inline(always)]
    #[must_use]
    pub fn dterrfc2(&mut self) -> Dterrfc2W<ClrSpec> {
        Dterrfc2W::new(self, 7)
    }
    #[doc = "Bit 8 - Channel 3 Global flag clear"]
    #[inline(always)]
    #[must_use]
    pub fn gfc3(&mut self) -> Gfc3W<ClrSpec> {
        Gfc3W::new(self, 8)
    }
    #[doc = "Bit 9 - Channel 3 full data transfer flag clear"]
    #[inline(always)]
    #[must_use]
    pub fn fdtfc3(&mut self) -> Fdtfc3W<ClrSpec> {
        Fdtfc3W::new(self, 9)
    }
    #[doc = "Bit 10 - Channel 3 half data transfer flag clear"]
    #[inline(always)]
    #[must_use]
    pub fn hdtfc3(&mut self) -> Hdtfc3W<ClrSpec> {
        Hdtfc3W::new(self, 10)
    }
    #[doc = "Bit 11 - Channel 3 data transfer error flag clear"]
    #[inline(always)]
    #[must_use]
    pub fn dterrfc3(&mut self) -> Dterrfc3W<ClrSpec> {
        Dterrfc3W::new(self, 11)
    }
    #[doc = "Bit 12 - Channel 4 Global flag clear"]
    #[inline(always)]
    #[must_use]
    pub fn gfc4(&mut self) -> Gfc4W<ClrSpec> {
        Gfc4W::new(self, 12)
    }
    #[doc = "Bit 13 - Channel 4 full data transfer flag clear"]
    #[inline(always)]
    #[must_use]
    pub fn fdtfc4(&mut self) -> Fdtfc4W<ClrSpec> {
        Fdtfc4W::new(self, 13)
    }
    #[doc = "Bit 14 - Channel 4 half data transfer flag clear"]
    #[inline(always)]
    #[must_use]
    pub fn hdtfc4(&mut self) -> Hdtfc4W<ClrSpec> {
        Hdtfc4W::new(self, 14)
    }
    #[doc = "Bit 15 - Channel 4 data transfer error flag clear"]
    #[inline(always)]
    #[must_use]
    pub fn dterrfc4(&mut self) -> Dterrfc4W<ClrSpec> {
        Dterrfc4W::new(self, 15)
    }
    #[doc = "Bit 16 - Channel 5 Global flag clear"]
    #[inline(always)]
    #[must_use]
    pub fn gfc5(&mut self) -> Gfc5W<ClrSpec> {
        Gfc5W::new(self, 16)
    }
    #[doc = "Bit 17 - Channel 5 full data transfer flag clear"]
    #[inline(always)]
    #[must_use]
    pub fn fdtfc5(&mut self) -> Fdtfc5W<ClrSpec> {
        Fdtfc5W::new(self, 17)
    }
    #[doc = "Bit 18 - Channel 5 half data transfer flag clear"]
    #[inline(always)]
    #[must_use]
    pub fn hdtfc5(&mut self) -> Hdtfc5W<ClrSpec> {
        Hdtfc5W::new(self, 18)
    }
    #[doc = "Bit 19 - Channel 5 data transfer error flag clear"]
    #[inline(always)]
    #[must_use]
    pub fn dterrfc5(&mut self) -> Dterrfc5W<ClrSpec> {
        Dterrfc5W::new(self, 19)
    }
    #[doc = "Bit 20 - Channel 6 Global flag clear"]
    #[inline(always)]
    #[must_use]
    pub fn gfc6(&mut self) -> Gfc6W<ClrSpec> {
        Gfc6W::new(self, 20)
    }
    #[doc = "Bit 21 - Channel 6 full data transfer flag clear"]
    #[inline(always)]
    #[must_use]
    pub fn fdtfc6(&mut self) -> Fdtfc6W<ClrSpec> {
        Fdtfc6W::new(self, 21)
    }
    #[doc = "Bit 22 - Channel 6 half data transfer flag clear"]
    #[inline(always)]
    #[must_use]
    pub fn hdtfc6(&mut self) -> Hdtfc6W<ClrSpec> {
        Hdtfc6W::new(self, 22)
    }
    #[doc = "Bit 23 - Channel 6 data transfer error flag clear"]
    #[inline(always)]
    #[must_use]
    pub fn dterrfc6(&mut self) -> Dterrfc6W<ClrSpec> {
        Dterrfc6W::new(self, 23)
    }
    #[doc = "Bit 24 - Channel 7 Global flag clear"]
    #[inline(always)]
    #[must_use]
    pub fn gfc7(&mut self) -> Gfc7W<ClrSpec> {
        Gfc7W::new(self, 24)
    }
    #[doc = "Bit 25 - Channel 7 full data transfer flag clear"]
    #[inline(always)]
    #[must_use]
    pub fn fdtfc7(&mut self) -> Fdtfc7W<ClrSpec> {
        Fdtfc7W::new(self, 25)
    }
    #[doc = "Bit 26 - Channel 7 half data transfer flag clear"]
    #[inline(always)]
    #[must_use]
    pub fn hdtfc7(&mut self) -> Hdtfc7W<ClrSpec> {
        Hdtfc7W::new(self, 26)
    }
    #[doc = "Bit 27 - Channel 7 data transfer error flag clear"]
    #[inline(always)]
    #[must_use]
    pub fn dterrfc7(&mut self) -> Dterrfc7W<ClrSpec> {
        Dterrfc7W::new(self, 27)
    }
}
