#[doc = "Register `C7CTRL` reader"]
pub type R = crate::R<C7ctrlSpec>;
#[doc = "Register `C7CTRL` writer"]
pub type W = crate::W<C7ctrlSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn chen(&mut self) -> ChenW<C7ctrlSpec> {
        ChenW::new(self, 0)
    }
    #[doc = "Bit 1 - Transfer complete interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn fdtien(&mut self) -> FdtienW<C7ctrlSpec> {
        FdtienW::new(self, 1)
    }
    #[doc = "Bit 2 - Half transfer interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn hdtien(&mut self) -> HdtienW<C7ctrlSpec> {
        HdtienW::new(self, 2)
    }
    #[doc = "Bit 3 - Transfer error interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn dterrien(&mut self) -> DterrienW<C7ctrlSpec> {
        DterrienW::new(self, 3)
    }
    #[doc = "Bit 4 - Data transfer direction"]
    #[inline(always)]
    #[must_use]
    pub fn dtd(&mut self) -> DtdW<C7ctrlSpec> {
        DtdW::new(self, 4)
    }
    #[doc = "Bit 5 - Loop mode"]
    #[inline(always)]
    #[must_use]
    pub fn lm(&mut self) -> LmW<C7ctrlSpec> {
        LmW::new(self, 5)
    }
    #[doc = "Bit 6 - Peripheral increment mode"]
    #[inline(always)]
    #[must_use]
    pub fn pincm(&mut self) -> PincmW<C7ctrlSpec> {
        PincmW::new(self, 6)
    }
    #[doc = "Bit 7 - Memory increment mode"]
    #[inline(always)]
    #[must_use]
    pub fn mincm(&mut self) -> MincmW<C7ctrlSpec> {
        MincmW::new(self, 7)
    }
    #[doc = "Bits 8:9 - Peripheral data bit width"]
    #[inline(always)]
    #[must_use]
    pub fn pwidth(&mut self) -> PwidthW<C7ctrlSpec> {
        PwidthW::new(self, 8)
    }
    #[doc = "Bits 10:11 - Memory data bit width"]
    #[inline(always)]
    #[must_use]
    pub fn mwidth(&mut self) -> MwidthW<C7ctrlSpec> {
        MwidthW::new(self, 10)
    }
    #[doc = "Bits 12:13 - Channel Priority level"]
    #[inline(always)]
    #[must_use]
    pub fn chpl(&mut self) -> ChplW<C7ctrlSpec> {
        ChplW::new(self, 12)
    }
    #[doc = "Bit 14 - Memory to memory mode"]
    #[inline(always)]
    #[must_use]
    pub fn m2m(&mut self) -> M2mW<C7ctrlSpec> {
        M2mW::new(self, 14)
    }
}
#[doc = "DMA channel configuration register(DMA_C7CTRL)\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`c7ctrl::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`c7ctrl::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct C7ctrlSpec;
impl crate::RegisterSpec for C7ctrlSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`c7ctrl::R`](R) reader structure"]
impl crate::Readable for C7ctrlSpec {}
#[doc = "`write(|w| ..)` method takes [`c7ctrl::W`](W) writer structure"]
impl crate::Writable for C7ctrlSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets C7CTRL to value 0"]
impl crate::Resettable for C7ctrlSpec {
