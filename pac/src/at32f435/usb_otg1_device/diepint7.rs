...
pub type R = crate::R<Diepint7Spec>;
#[doc = "Register `DIEPINT7` writer"]
pub type W = crate::W<Diepint7Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn xferc(&mut self) -> XfercW<Diepint7Spec> {
        XfercW::new(self, 0)
    }
    #[doc = "Bit 1 - Endpoint disabled interrupt"]
    #[inline(always)]
    #[must_use]
    pub fn eptdisd(&mut self) -> EptdisdW<Diepint7Spec> {
        EptdisdW::new(self, 1)
    }
    #[doc = "Bit 3 - Timeout condition"]
    #[inline(always)]
    #[must_use]
    pub fn timeout(&mut self) -> TimeoutW<Diepint7Spec> {
        TimeoutW::new(self, 3)
    }
    #[doc = "Bit 4 - IN token received when TxFIFO is empty"]
    #[inline(always)]
    #[must_use]
    pub fn intkntxfemp(&mut self) -> IntkntxfempW<Diepint7Spec> {
        IntkntxfempW::new(self, 4)
    }
    #[doc = "Bit 6 - IN endpoint NAK effective"]
    #[inline(always)]
    #[must_use]
    pub fn ineptnak(&mut self) -> IneptnakW<Diepint7Spec> {
...
pub struct Diepint7Spec;
impl crate::RegisterSpec for Diepint7Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`diepint7::R`](R) reader structure"]
impl crate::Readable for Diepint7Spec {}
#[doc = "`write(|w| ..)` method takes [`diepint7::W`](W) writer structure"]
impl crate::Writable for Diepint7Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DIEPINT7 to value 0x80"]
impl crate::Resettable for Diepint7Spec {
