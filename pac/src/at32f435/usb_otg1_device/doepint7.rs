...
pub type R = crate::R<Doepint7Spec>;
#[doc = "Register `DOEPINT7` writer"]
pub type W = crate::W<Doepint7Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn xferc(&mut self) -> XfercW<Doepint7Spec> {
        XfercW::new(self, 0)
    }
    #[doc = "Bit 1 - Endpoint disabled interrupt"]
    #[inline(always)]
    #[must_use]
    pub fn eptdisd(&mut self) -> EptdisdW<Doepint7Spec> {
        EptdisdW::new(self, 1)
    }
    #[doc = "Bit 3 - SETUP phase done"]
    #[inline(always)]
    #[must_use]
    pub fn setup(&mut self) -> SetupW<Doepint7Spec> {
        SetupW::new(self, 3)
    }
    #[doc = "Bit 4 - OUT token received when endpoint disabled"]
    #[inline(always)]
    #[must_use]
    pub fn outtepd(&mut self) -> OuttepdW<Doepint7Spec> {
        OuttepdW::new(self, 4)
    }
    #[doc = "Bit 6 - Back-to-back SETUP packets received"]
    #[inline(always)]
    #[must_use]
    pub fn b2bstup(&mut self) -> B2bstupW<Doepint7Spec> {
        B2bstupW::new(self, 6)
    }
}
#[doc = "OTGFS device OUT endpoint-7 interrupt register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`doepint7::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`doepint7::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Doepint7Spec;
impl crate::RegisterSpec for Doepint7Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`doepint7::R`](R) reader structure"]
impl crate::Readable for Doepint7Spec {}
#[doc = "`write(|w| ..)` method takes [`doepint7::W`](W) writer structure"]
impl crate::Writable for Doepint7Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DOEPINT7 to value 0x80"]
impl crate::Resettable for Doepint7Spec {
