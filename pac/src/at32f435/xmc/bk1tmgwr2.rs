...
pub type R = crate::R<Bk1tmgwr2Spec>;
#[doc = "Register `BK1TMGWR2` writer"]
pub type W = crate::W<Bk1tmgwr2Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn addrst(&mut self) -> AddrstW<Bk1tmgwr2Spec> {
        AddrstW::new(self, 0)
    }
    #[doc = "Bits 4:7 - Address-hold time"]
    #[inline(always)]
    #[must_use]
    pub fn addrht(&mut self) -> AddrhtW<Bk1tmgwr2Spec> {
        AddrhtW::new(self, 4)
    }
    #[doc = "Bits 8:15 - Asynchronous data setup time"]
    #[inline(always)]
    #[must_use]
    pub fn dtst(&mut self) -> DtstW<Bk1tmgwr2Spec> {
        DtstW::new(self, 8)
    }
    #[doc = "Bits 16:19 - Bus latency"]
    #[inline(always)]
    #[must_use]
    pub fn buslat(&mut self) -> BuslatW<Bk1tmgwr2Spec> {
        BuslatW::new(self, 16)
    }
    #[doc = "Bits 28:29 - Asynchronous mode"]
    #[inline(always)]
    #[must_use]
    pub fn asyncm(&mut self) -> AsyncmW<Bk1tmgwr2Spec> {
        AsyncmW::new(self, 28)
    }
}
