...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ca(&mut self) -> CaW<Ctrl2Spec> {
        CaW::new(self, 0)
    }
    #[doc = "Bits 2:3 - Number of row address bits"]
    #[inline(always)]
    #[must_use]
    pub fn ra(&mut self) -> RaW<Ctrl2Spec> {
        RaW::new(self, 2)
    }
    #[doc = "Bits 4:5 - Memory data bus width"]
    #[inline(always)]
    #[must_use]
    pub fn db(&mut self) -> DbW<Ctrl2Spec> {
        DbW::new(self, 4)
    }
    #[doc = "Bit 6 - Number of internal banks"]
    #[inline(always)]
    #[must_use]
    pub fn inbk(&mut self) -> InbkW<Ctrl2Spec> {
        InbkW::new(self, 6)
    }
    #[doc = "Bits 7:8 - CAS latency"]
    #[inline(always)]
    #[must_use]
    pub fn cas(&mut self) -> CasW<Ctrl2Spec> {
        CasW::new(self, 7)
    }
    #[doc = "Bit 9 - Write protection"]
    #[inline(always)]
    #[must_use]
    pub fn wrp(&mut self) -> WrpW<Ctrl2Spec> {
        WrpW::new(self, 9)
    }
    #[doc = "Bits 10:11 - Clock division configuration"]
    #[inline(always)]
    #[must_use]
    pub fn clkdiv(&mut self) -> ClkdivW<Ctrl2Spec> {
        ClkdivW::new(self, 10)
    }
    #[doc = "Bit 12 - Burst read"]
    #[inline(always)]
    #[must_use]
    pub fn bstr(&mut self) -> BstrW<Ctrl2Spec> {
        BstrW::new(self, 12)
    }
    #[doc = "Bits 13:14 - Read pipe"]
    #[inline(always)]
    #[must_use]
    pub fn rd(&mut self) -> RdW<Ctrl2Spec> {
        RdW::new(self, 13)
    }
}
