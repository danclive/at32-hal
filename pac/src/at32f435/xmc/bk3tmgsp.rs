...
pub type R = crate::R<Bk3tmgspSpec>;
#[doc = "Register `BK3TMGSP` writer"]
pub type W = crate::W<Bk3tmgspSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn spst(&mut self) -> SpstW<Bk3tmgspSpec> {
        SpstW::new(self, 0)
    }
    #[doc = "Bits 8:15 - special memory wait time"]
    #[inline(always)]
    #[must_use]
    pub fn spwt(&mut self) -> SpwtW<Bk3tmgspSpec> {
        SpwtW::new(self, 8)
    }
    #[doc = "Bits 16:23 - special memory hold time"]
    #[inline(always)]
    #[must_use]
    pub fn spht(&mut self) -> SphtW<Bk3tmgspSpec> {
        SphtW::new(self, 16)
    }
    #[doc = "Bits 24:31 - special memory databus High resistance time"]
    #[inline(always)]
    #[must_use]
    pub fn spdhizt(&mut self) -> SpdhiztW<Bk3tmgspSpec> {
