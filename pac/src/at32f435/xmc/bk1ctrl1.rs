#[doc = "Register `BK1CTRL1` reader"]
pub type R = crate::R<Bk1ctrl1Spec>;
#[doc = "Register `BK1CTRL1` writer"]
pub type W = crate::W<Bk1ctrl1Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn en(&mut self) -> EnW<Bk1ctrl1Spec> {
        EnW::new(self, 0)
    }
    #[doc = "Bit 1 - Address and data multiplexing enable"]
    #[inline(always)]
    #[must_use]
    pub fn admuxen(&mut self) -> AdmuxenW<Bk1ctrl1Spec> {
        AdmuxenW::new(self, 1)
    }
    #[doc = "Bits 2:3 - Memory device type"]
    #[inline(always)]
    #[must_use]
    pub fn dev(&mut self) -> DevW<Bk1ctrl1Spec> {
        DevW::new(self, 2)
    }
    #[doc = "Bits 4:5 - External memory data bus width"]
    #[inline(always)]
    #[must_use]
    pub fn extmdbw(&mut self) -> ExtmdbwW<Bk1ctrl1Spec> {
        ExtmdbwW::new(self, 4)
    }
    #[doc = "Bit 6 - Nor flash access enable"]
    #[inline(always)]
    #[must_use]
    pub fn noren(&mut self) -> NorenW<Bk1ctrl1Spec> {
        NorenW::new(self, 6)
    }
    #[doc = "Bit 8 - Synchronous burst enable"]
    #[inline(always)]
    #[must_use]
    pub fn syncben(&mut self) -> SyncbenW<Bk1ctrl1Spec> {
        SyncbenW::new(self, 8)
    }
    #[doc = "Bit 9 - NWAIT polarity"]
    #[inline(always)]
    #[must_use]
    pub fn nwpol(&mut self) -> NwpolW<Bk1ctrl1Spec> {
        NwpolW::new(self, 9)
    }
    #[doc = "Bit 10 - Wrapped enable"]
    #[inline(always)]
    #[must_use]
    pub fn wrapen(&mut self) -> WrapenW<Bk1ctrl1Spec> {
        WrapenW::new(self, 10)
    }
    #[doc = "Bit 11 - Wait timing configuration"]
    #[inline(always)]
    #[must_use]
    pub fn nwtcfg(&mut self) -> NwtcfgW<Bk1ctrl1Spec> {
        NwtcfgW::new(self, 11)
    }
    #[doc = "Bit 12 - Write enable"]
    #[inline(always)]
    #[must_use]
    pub fn wen(&mut self) -> WenW<Bk1ctrl1Spec> {
        WenW::new(self, 12)
    }
    #[doc = "Bit 13 - NWAIT in synchronous transfer enable"]
    #[inline(always)]
    #[must_use]
    pub fn nwsen(&mut self) -> NwsenW<Bk1ctrl1Spec> {
        NwsenW::new(self, 13)
    }
    #[doc = "Bit 14 - Read-write timing different"]
    #[inline(always)]
    #[must_use]
    pub fn rwtd(&mut self) -> RwtdW<Bk1ctrl1Spec> {
        RwtdW::new(self, 14)
    }
    #[doc = "Bit 15 - NWAIT in asynchronous transfer enable"]
    #[inline(always)]
    #[must_use]
    pub fn nwasen(&mut self) -> NwasenW<Bk1ctrl1Spec> {
        NwasenW::new(self, 15)
    }
    #[doc = "Bits 16:18 - CRAM page size"]
    #[inline(always)]
    #[must_use]
    pub fn crpgs(&mut self) -> CrpgsW<Bk1ctrl1Spec> {
        CrpgsW::new(self, 16)
    }
    #[doc = "Bit 19 - Memory write mode control"]
    #[inline(always)]
    #[must_use]
    pub fn mwmc(&mut self) -> MwmcW<Bk1ctrl1Spec> {
        MwmcW::new(self, 19)
    }
}
#[doc = "SRAM/NOR-Flash chip-select control register 1\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`bk1ctrl1::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`bk1ctrl1::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Bk1ctrl1Spec;
impl crate::RegisterSpec for Bk1ctrl1Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`bk1ctrl1::R`](R) reader structure"]
impl crate::Readable for Bk1ctrl1Spec {}
#[doc = "`write(|w| ..)` method takes [`bk1ctrl1::W`](W) writer structure"]
impl crate::Writable for Bk1ctrl1Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets BK1CTRL1 to value 0x30db"]
impl crate::Resettable for Bk1ctrl1Spec {
