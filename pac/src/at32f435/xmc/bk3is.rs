#[doc = "Register `BK3IS` reader"]
pub type R = crate::R<Bk3isSpec>;
#[doc = "Register `BK3IS` writer"]
pub type W = crate::W<Bk3isSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn res(&mut self) -> ResW<Bk3isSpec> {
        ResW::new(self, 0)
    }
    #[doc = "Bit 1 - High-level status"]
    #[inline(always)]
    #[must_use]
    pub fn hls(&mut self) -> HlsW<Bk3isSpec> {
        HlsW::new(self, 1)
    }
    #[doc = "Bit 2 - Falling edge status"]
    #[inline(always)]
    #[must_use]
    pub fn fes(&mut self) -> FesW<Bk3isSpec> {
        FesW::new(self, 2)
    }
    #[doc = "Bit 3 - Rising edge interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn reien(&mut self) -> ReienW<Bk3isSpec> {
        ReienW::new(self, 3)
    }
    #[doc = "Bit 4 - High-level interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn hlien(&mut self) -> HlienW<Bk3isSpec> {
        HlienW::new(self, 4)
    }
    #[doc = "Bit 5 - Falling edge interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn feien(&mut self) -> FeienW<Bk3isSpec> {
        FeienW::new(self, 5)
    }
}
#[doc = "FIFO status and interrupt register 3\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`bk3is::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`bk3is::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Bk3isSpec;
impl crate::RegisterSpec for Bk3isSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`bk3is::R`](R) reader structure"]
impl crate::Readable for Bk3isSpec {}
#[doc = "`write(|w| ..)` method takes [`bk3is::W`](W) writer structure"]
impl crate::Writable for Bk3isSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets BK3IS to value 0x40"]
impl crate::Resettable for Bk3isSpec {
