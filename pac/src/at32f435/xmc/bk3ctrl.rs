...
pub type R = crate::R<Bk3ctrlSpec>;
#[doc = "Register `BK3CTRL` writer"]
pub type W = crate::W<Bk3ctrlSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn nwen(&mut self) -> NwenW<Bk3ctrlSpec> {
        NwenW::new(self, 1)
    }
    #[doc = "Bit 2 - Memory bank enable"]
    #[inline(always)]
    #[must_use]
    pub fn en(&mut self) -> EnW<Bk3ctrlSpec> {
        EnW::new(self, 2)
    }
    #[doc = "Bit 3 - Memory device type"]
    #[inline(always)]
    #[must_use]
    pub fn dev(&mut self) -> DevW<Bk3ctrlSpec> {
        DevW::new(self, 3)
    }
    #[doc = "Bits 4:5 - External memory data bus width"]
    #[inline(always)]
    #[must_use]
    pub fn extmdbw(&mut self) -> ExtmdbwW<Bk3ctrlSpec> {
        ExtmdbwW::new(self, 4)
    }
    #[doc = "Bit 6 - ECC enable"]
    #[inline(always)]
    #[must_use]
    pub fn eccen(&mut self) -> EccenW<Bk3ctrlSpec> {
        EccenW::new(self, 6)
    }
    #[doc = "Bits 9:12 - CLE to RE delay"]
    #[inline(always)]
    #[must_use]
    pub fn tcr(&mut self) -> TcrW<Bk3ctrlSpec> {
        TcrW::new(self, 9)
    }
    #[doc = "Bits 13:16 - ALE to RE delay"]
    #[inline(always)]
    #[must_use]
    pub fn tar(&mut self) -> TarW<Bk3ctrlSpec> {
        TarW::new(self, 13)
    }
    #[doc = "Bits 17:19 - ECC page size"]
    #[inline(always)]
    #[must_use]
    pub fn eccpgs(&mut self) -> EccpgsW<Bk3ctrlSpec> {
        EccpgsW::new(self, 17)
    }
}
...
pub struct Bk3ctrlSpec;
impl crate::RegisterSpec for Bk3ctrlSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`bk3ctrl::R`](R) reader structure"]
impl crate::Readable for Bk3ctrlSpec {}
#[doc = "`write(|w| ..)` method takes [`bk3ctrl::W`](W) writer structure"]
impl crate::Writable for Bk3ctrlSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets BK3CTRL to value 0x18"]
impl crate::Resettable for Bk3ctrlSpec {
