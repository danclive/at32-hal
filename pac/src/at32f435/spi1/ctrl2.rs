...
pub type Mdiv3enR = crate::BitReader;
#[doc = "Field `MDIV3EN` writer - Master clock frequency3 division enable"]
pub type Mdiv3enW<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ...
    #[inline(always)]
    pub fn mdiv3en(&self) -> Mdiv3enR {
        Mdiv3enR::new(((self.bits >> 9) & 1) != 0)
    }
}
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tien(&mut self) -> TienW<Ctrl2Spec> {
        TienW::new(self, 4)
    }
    #[doc = "Bit 5 - Error interrupt enable"]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn mdiv3en(&mut self) -> Mdiv3enW<Ctrl2Spec> {
        Mdiv3enW::new(self, 9)
    }
}
