...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tmdt0(&mut self) -> Tmdt0W<Tmdtl0Spec> {
        Tmdt0W::new(self, 0)
    }
    #[doc = "Bits 8:15 - Transmit mailbox data byte 1"]
    #[inline(always)]
    #[must_use]
    pub fn tmdt1(&mut self) -> Tmdt1W<Tmdtl0Spec> {
        Tmdt1W::new(self, 8)
    }
    #[doc = "Bits 16:23 - Transmit mailbox data byte 2"]
    #[inline(always)]
    #[must_use]
    pub fn tmdt2(&mut self) -> Tmdt2W<Tmdtl0Spec> {
        Tmdt2W::new(self, 16)
    }
    #[doc = "Bits 24:31 - Transmit mailbox data byte 3"]
    #[inline(always)]
    #[must_use]
    pub fn tmdt3(&mut self) -> Tmdt3W<Tmdtl0Spec> {
        Tmdt3W::new(self, 24)
    }
}
#[doc = "Transmit mailbox 0 low byte data register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`tmdtl0::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`tmdtl0::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
