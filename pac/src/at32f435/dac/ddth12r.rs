...
pub type R = crate::R<Ddth12rSpec>;
#[doc = "Register `DDTH12R` writer"]
pub type W = crate::W<Ddth12rSpec>;
#[doc = "Field `DD1DT12R` reader - DAC1 12-bit right-aligned data"]
pub type Dd1dt12rR = crate::FieldReader<u16>;
#[doc = "Field `DD1DT12R` writer - DAC1 12-bit right-aligned data"]
pub type Dd1dt12rW<'a, REG> = crate::FieldWriter<'a, REG, 12, u16>;
#[doc = "Field `DD2DT12R` reader - DAC2 12-bit right-aligned data"]
pub type Dd2dt12rR = crate::FieldReader<u16>;
#[doc = "Field `DD2DT12R` writer - DAC2 12-bit right-aligned data"]
pub type Dd2dt12rW<'a, REG> = crate::FieldWriter<'a, REG, 12, u16>;
impl R {
    #[doc = "Bits 0:11 - DAC1 12-bit right-aligned data"]
    #[inline(always)]
    pub fn dd1dt12r(&self) -> Dd1dt12rR {
        Dd1dt12rR::new((self.bits & 0x0fff) as u16)
    }
    #[doc = "Bits 16:27 - DAC2 12-bit right-aligned data"]
    #[inline(always)]
    pub fn dd2dt12r(&self) -> Dd2dt12rR {
        Dd2dt12rR::new(((self.bits >> 16) & 0x0fff) as u16)
    }
}
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dd1dt12r(&mut self) -> Dd1dt12rW<Ddth12rSpec> {
        Dd1dt12rW::new(self, 0)
    }
    #[doc = "Bits 16:27 - DAC2 12-bit right-aligned data"]
    #[inline(always)]
    #[must_use]
    pub fn dd2dt12r(&mut self) -> Dd2dt12rW<Ddth12rSpec> {
        Dd2dt12rW::new(self, 16)
    }
}
...
pub struct Ddth12rSpec;
impl crate::RegisterSpec for Ddth12rSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ddth12r::R`](R) reader structure"]
impl crate::Readable for Ddth12rSpec {}
#[doc = "`write(|w| ..)` method takes [`ddth12r::W`](W) writer structure"]
impl crate::Writable for Ddth12rSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DDTH12R to value 0"]
impl crate::Resettable for Ddth12rSpec {
