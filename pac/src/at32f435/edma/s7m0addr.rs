...
pub type R = crate::R<S7m0addrSpec>;
#[doc = "Register `S7M0ADDR` writer"]
pub type W = crate::W<S7m0addrSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn m0addr(&mut self) -> M0addrW<S7m0addrSpec> {
        M0addrW::new(self, 0)
    }
}
...
pub struct S7m0addrSpec;
impl crate::RegisterSpec for S7m0addrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`s7m0addr::R`](R) reader structure"]
impl crate::Readable for S7m0addrSpec {}
#[doc = "`write(|w| ..)` method takes [`s7m0addr::W`](W) writer structure"]
impl crate::Writable for S7m0addrSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets S7M0ADDR to value 0"]
impl crate::Resettable for S7m0addrSpec {
