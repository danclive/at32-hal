...
pub type R = crate::R<S2dtcntSpec>;
#[doc = "Register `S2DTCNT` writer"]
pub type W = crate::W<S2dtcntSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cnt(&mut self) -> CntW<S2dtcntSpec> {
        CntW::new(self, 0)
    }
}
...
pub struct S2dtcntSpec;
impl crate::RegisterSpec for S2dtcntSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`s2dtcnt::R`](R) reader structure"]
impl crate::Readable for S2dtcntSpec {}
#[doc = "`write(|w| ..)` method takes [`s2dtcnt::W`](W) writer structure"]
impl crate::Writable for S2dtcntSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets S2DTCNT to value 0"]
impl crate::Resettable for S2dtcntSpec {
