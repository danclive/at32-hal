...
pub type R = crate::R<S5paddrSpec>;
#[doc = "Register `S5PADDR` writer"]
pub type W = crate::W<S5paddrSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn paddr(&mut self) -> PaddrW<S5paddrSpec> {
        PaddrW::new(self, 0)
    }
}
...
pub struct S5paddrSpec;
impl crate::RegisterSpec for S5paddrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`s5paddr::R`](R) reader structure"]
impl crate::Readable for S5paddrSpec {}
#[doc = "`write(|w| ..)` method takes [`s5paddr::W`](W) writer structure"]
impl crate::Writable for S5paddrSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets S5PADDR to value 0"]
impl crate::Resettable for S5paddrSpec {
