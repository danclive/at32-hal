...
pub type R = crate::R<S4dtcntSpec>;
#[doc = "Register `S4DTCNT` writer"]
pub type W = crate::W<S4dtcntSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cnt(&mut self) -> CntW<S4dtcntSpec> {
        CntW::new(self, 0)
    }
}
...
pub struct S4dtcntSpec;
impl crate::RegisterSpec for S4dtcntSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`s4dtcnt::R`](R) reader structure"]
impl crate::Readable for S4dtcntSpec {}
#[doc = "`write(|w| ..)` method takes [`s4dtcnt::W`](W) writer structure"]
impl crate::Writable for S4dtcntSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets S4DTCNT to value 0"]
impl crate::Resettable for S4dtcntSpec {
