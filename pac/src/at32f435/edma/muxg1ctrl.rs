...
pub type R = crate::R<Muxg1ctrlSpec>;
#[doc = "Register `MUXG1CTRL` writer"]
pub type W = crate::W<Muxg1ctrlSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn sigsel(&mut self) -> SigselW<Muxg1ctrlSpec> {
        SigselW::new(self, 0)
    }
    #[doc = "Bit 8 - Trigger overrun interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn trgovien(&mut self) -> TrgovienW<Muxg1ctrlSpec> {
        TrgovienW::new(self, 8)
    }
    #[doc = "Bit 16 - DMA request generator enable"]
    #[inline(always)]
    #[must_use]
    pub fn gen(&mut self) -> GenW<Muxg1ctrlSpec> {
        GenW::new(self, 16)
    }
    #[doc = "Bits 17:18 - DMA request generator trigger polarity"]
    #[inline(always)]
    #[must_use]
    pub fn gpol(&mut self) -> GpolW<Muxg1ctrlSpec> {
        GpolW::new(self, 17)
    }
    #[doc = "Bits 19:23 - Number of DMA requests to be generated"]
    #[inline(always)]
    #[must_use]
    pub fn greqcnt(&mut self) -> GreqcntW<Muxg1ctrlSpec> {
        GreqcntW::new(self, 19)
    }
}
#[doc = "Generator 1 Configuration Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`muxg1ctrl::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`muxg1ctrl::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Muxg1ctrlSpec;
impl crate::RegisterSpec for Muxg1ctrlSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`muxg1ctrl::R`](R) reader structure"]
impl crate::Readable for Muxg1ctrlSpec {}
#[doc = "`write(|w| ..)` method takes [`muxg1ctrl::W`](W) writer structure"]
impl crate::Writable for Muxg1ctrlSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets MUXG1CTRL to value 0"]
impl crate::Resettable for Muxg1ctrlSpec {
