...
pub type R = crate::R<S1m0addrSpec>;
#[doc = "Register `S1M0ADDR` writer"]
pub type W = crate::W<S1m0addrSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn m0addr(&mut self) -> M0addrW<S1m0addrSpec> {
        M0addrW::new(self, 0)
    }
}
#[doc = "stream 1 memory 0 address register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`s1m0addr::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`s1m0addr::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct S1m0addrSpec;
impl crate::RegisterSpec for S1m0addrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`s1m0addr::R`](R) reader structure"]
impl crate::Readable for S1m0addrSpec {}
#[doc = "`write(|w| ..)` method takes [`s1m0addr::W`](W) writer structure"]
impl crate::Writable for S1m0addrSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets S1M0ADDR to value 0"]
impl crate::Resettable for S1m0addrSpec {
