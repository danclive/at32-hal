...
pub type R = crate::R<S8paddrSpec>;
#[doc = "Register `S8PADDR` writer"]
pub type W = crate::W<S8paddrSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn paddr(&mut self) -> PaddrW<S8paddrSpec> {
        PaddrW::new(self, 0)
    }
}
...
pub struct S8paddrSpec;
impl crate::RegisterSpec for S8paddrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`s8paddr::R`](R) reader structure"]
impl crate::Readable for S8paddrSpec {}
#[doc = "`write(|w| ..)` method takes [`s8paddr::W`](W) writer structure"]
impl crate::Writable for S8paddrSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets S8PADDR to value 0"]
impl crate::Resettable for S8paddrSpec {
