...
pub type R = crate::R<S4_2dcntSpec>;
#[doc = "Register `S4_2DCNT` writer"]
pub type W = crate::W<S4_2dcntSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn xconut(&mut self) -> XconutW<S4_2dcntSpec> {
        XconutW::new(self, 0)
    }
    #[doc = "Bits 16:31 - Y dimension transfer count"]
    #[inline(always)]
    #[must_use]
    pub fn yconut(&mut self) -> YconutW<S4_2dcntSpec> {
        YconutW::new(self, 16)
    }
}
...
pub struct S4_2dcntSpec;
impl crate::RegisterSpec for S4_2dcntSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`s4_2dcnt::R`](R) reader structure"]
impl crate::Readable for S4_2dcntSpec {}
#[doc = "`write(|w| ..)` method takes [`s4_2dcnt::W`](W) writer structure"]
impl crate::Writable for S4_2dcntSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets S4_2DCNT to value 0"]
impl crate::Resettable for S4_2dcntSpec {
