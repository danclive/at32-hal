...
pub type R = crate::R<S6m1addrSpec>;
#[doc = "Register `S6M1ADDR` writer"]
pub type W = crate::W<S6m1addrSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn m1addr(&mut self) -> M1addrW<S6m1addrSpec> {
        M1addrW::new(self, 0)
    }
}
#[doc = "stream 6 memory 1 address register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`s6m1addr::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`s6m1addr::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct S6m1addrSpec;
impl crate::RegisterSpec for S6m1addrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`s6m1addr::R`](R) reader structure"]
impl crate::Readable for S6m1addrSpec {}
#[doc = "`write(|w| ..)` method takes [`s6m1addr::W`](W) writer structure"]
impl crate::Writable for S6m1addrSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets S6M1ADDR to value 0"]
impl crate::Resettable for S6m1addrSpec {
