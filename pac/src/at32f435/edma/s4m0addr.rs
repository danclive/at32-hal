...
pub type R = crate::R<S4m0addrSpec>;
#[doc = "Register `S4M0ADDR` writer"]
pub type W = crate::W<S4m0addrSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn m0addr(&mut self) -> M0addrW<S4m0addrSpec> {
        M0addrW::new(self, 0)
    }
}
...
pub struct S4m0addrSpec;
impl crate::RegisterSpec for S4m0addrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`s4m0addr::R`](R) reader structure"]
impl crate::Readable for S4m0addrSpec {}
#[doc = "`write(|w| ..)` method takes [`s4m0addr::W`](W) writer structure"]
impl crate::Writable for S4m0addrSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets S4M0ADDR to value 0"]
impl crate::Resettable for S4m0addrSpec {
