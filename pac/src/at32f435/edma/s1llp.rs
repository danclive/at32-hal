...
pub type R = crate::R<S1llpSpec>;
#[doc = "Register `S1LLP` writer"]
pub type W = crate::W<S1llpSpec>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("S1LLP").field("llp", &self.llp()).finish()
    }
}
impl W {
    #[doc = "Bits 0:31 - Link list pointer"]
    #[inline(always)]
    #[must_use]
    pub fn llp(&mut self) -> LlpW<S1llpSpec> {
        LlpW::new(self, 0)
    }
}
...
pub struct S1llpSpec;
impl crate::RegisterSpec for S1llpSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`s1llp::R`](R) reader structure"]
impl crate::Readable for S1llpSpec {}
#[doc = "`write(|w| ..)` method takes [`s1llp::W`](W) writer structure"]
impl crate::Writable for S1llpSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets S1LLP to value 0"]
impl crate::Resettable for S1llpSpec {
