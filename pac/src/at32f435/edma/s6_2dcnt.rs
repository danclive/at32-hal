...
pub type R = crate::R<S6_2dcntSpec>;
#[doc = "Register `S6_2DCNT` writer"]
pub type W = crate::W<S6_2dcntSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn xconut(&mut self) -> XconutW<S6_2dcntSpec> {
        XconutW::new(self, 0)
    }
    #[doc = "Bits 16:31 - Y dimension transfer count"]
    #[inline(always)]
    #[must_use]
    pub fn yconut(&mut self) -> YconutW<S6_2dcntSpec> {
        YconutW::new(self, 16)
    }
}
...
pub struct S6_2dcntSpec;
impl crate::RegisterSpec for S6_2dcntSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`s6_2dcnt::R`](R) reader structure"]
impl crate::Readable for S6_2dcntSpec {}
#[doc = "`write(|w| ..)` method takes [`s6_2dcnt::W`](W) writer structure"]
impl crate::Writable for S6_2dcntSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets S6_2DCNT to value 0"]
impl crate::Resettable for S6_2dcntSpec {
