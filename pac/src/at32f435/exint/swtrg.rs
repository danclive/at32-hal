...
#[doc = "Field `SWT20` reader - Software triggle on line 20"]
pub type Swt20R = crate::BitReader;
#[doc = "Field `SWT20` writer - Software triggle on line 20"]
pub type Swt20W<'a, REG> = crate::BitWriter<'a, REG>;
...
#[doc = "Field `SWT22` reader - Software triggle on line 22"]
pub type Swt22R = crate::BitReader;
#[doc = "Field `SWT22` writer - Software triggle on line 22"]
pub type Swt22W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ...
    #[doc = "Bit 20 - Software triggle on line 20"]
    #[inline(always)]
    pub fn swt20(&self) -> Swt20R {
        Swt20R::new(((self.bits >> 20) & 1) != 0)
    }
    ...
    #[doc = "Bit 22 - Software triggle on line 22"]
    #[inline(always)]
    pub fn swt22(&self) -> Swt22R {
        Swt22R::new(((self.bits >> 22) & 1) != 0)
    }
}
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn swt19(&mut self) -> Swt19W<SwtrgSpec> {
        Swt19W::new(self, 19)
    }
    #[doc = "Bit 20 - Software triggle on line 20"]
    #[inline(always)]
    #[must_use]
    pub fn swt20(&mut self) -> Swt20W<SwtrgSpec> {
        Swt20W::new(self, 20)
    }
    #[doc = "Bit 21 - Software triggle on line 21"]
    #[inline(always)]
    #[must_use]
    pub fn swt21(&mut self) -> Swt21W<SwtrgSpec> {
        Swt21W::new(self, 21)
    }
    #[doc = "Bit 22 - Software triggle on line 22"]
    #[inline(always)]
    #[must_use]
    pub fn swt22(&mut self) -> Swt22W<SwtrgSpec> {
        Swt22W::new(self, 22)
    }
}
