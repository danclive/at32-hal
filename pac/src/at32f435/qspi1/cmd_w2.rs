...
pub type R = crate::R<CmdW2Spec>;
#[doc = "Register `CMD_W2` writer"]
pub type W = crate::W<CmdW2Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dcnt(&mut self) -> DcntW<CmdW2Spec> {
        DcntW::new(self, 0)
    }
}
