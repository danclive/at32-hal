...
pub type R = crate::R<Bpr16dtSpec>;
#[doc = "Register `BPR16DT` writer"]
pub type W = crate::W<Bpr16dtSpec>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("BPR16DT").field("dt", &self.dt()).finish()
    }
}
impl W {
    #[doc = "Bits 0:31 - Battery powered domain data"]
    #[inline(always)]
    #[must_use]
    pub fn dt(&mut self) -> DtW<Bpr16dtSpec> {
        DtW::new(self, 0)
    }
}
...
pub struct Bpr16dtSpec;
impl crate::RegisterSpec for Bpr16dtSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`bpr16dt::R`](R) reader structure"]
impl crate::Readable for Bpr16dtSpec {}
#[doc = "`write(|w| ..)` method takes [`bpr16dt::W`](W) writer structure"]
impl crate::Writable for Bpr16dtSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets BPR16DT to value 0"]
impl crate::Resettable for Bpr16dtSpec {
