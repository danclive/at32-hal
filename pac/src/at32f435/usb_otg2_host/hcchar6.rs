...
pub type R = crate::R<Hcchar6Spec>;
#[doc = "Register `HCCHAR6` writer"]
pub type W = crate::W<Hcchar6Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn mps(&mut self) -> MpsW<Hcchar6Spec> {
        MpsW::new(self, 0)
    }
    #[doc = "Bits 11:14 - Endpoint number"]
    #[inline(always)]
    #[must_use]
    pub fn eptnum(&mut self) -> EptnumW<Hcchar6Spec> {
        EptnumW::new(self, 11)
    }
    #[doc = "Bit 15 - Endpoint direction"]
    #[inline(always)]
    #[must_use]
    pub fn eptdir(&mut self) -> EptdirW<Hcchar6Spec> {
        EptdirW::new(self, 15)
    }
    #[doc = "Bit 17 - Low-speed device"]
    #[inline(always)]
    #[must_use]
    pub fn lspddev(&mut self) -> LspddevW<Hcchar6Spec> {
        LspddevW::new(self, 17)
    }
    #[doc = "Bits 18:19 - Endpoint type"]
    #[inline(always)]
    #[must_use]
    pub fn eptype(&mut self) -> EptypeW<Hcchar6Spec> {
        EptypeW::new(self, 18)
    }
    #[doc = "Bits 20:21 - Multicount"]
    #[inline(always)]
    #[must_use]
    pub fn mc(&mut self) -> McW<Hcchar6Spec> {
        McW::new(self, 20)
    }
    #[doc = "Bits 22:28 - Device address"]
    #[inline(always)]
    #[must_use]
    pub fn devaddr(&mut self) -> DevaddrW<Hcchar6Spec> {
        DevaddrW::new(self, 22)
    }
    #[doc = "Bit 29 - Odd frame"]
    #[inline(always)]
    #[must_use]
    pub fn oddfrm(&mut self) -> OddfrmW<Hcchar6Spec> {
        OddfrmW::new(self, 29)
    }
    #[doc = "Bit 30 - Channel disable"]
    #[inline(always)]
    #[must_use]
    pub fn chdis(&mut self) -> ChdisW<Hcchar6Spec> {
        ChdisW::new(self, 30)
    }
    #[doc = "Bit 31 - Channel enable"]
    #[inline(always)]
    #[must_use]
    pub fn chena(&mut self) -> ChenaW<Hcchar6Spec> {
        ChenaW::new(self, 31)
    }
}
...
pub struct Hcchar6Spec;
impl crate::RegisterSpec for Hcchar6Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`hcchar6::R`](R) reader structure"]
impl crate::Readable for Hcchar6Spec {}
#[doc = "`write(|w| ..)` method takes [`hcchar6::W`](W) writer structure"]
impl crate::Writable for Hcchar6Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets HCCHAR6 to value 0"]
impl crate::Resettable for Hcchar6Spec {
