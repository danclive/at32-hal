...
pub type R = crate::R<Hctsiz0Spec>;
#[doc = "Register `HCTSIZ0` writer"]
pub type W = crate::W<Hctsiz0Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn xfersize(&mut self) -> XfersizeW<Hctsiz0Spec> {
        XfersizeW::new(self, 0)
    }
    #[doc = "Bits 19:28 - Packet count"]
    #[inline(always)]
    #[must_use]
    pub fn pktcnt(&mut self) -> PktcntW<Hctsiz0Spec> {
        PktcntW::new(self, 19)
    }
    #[doc = "Bits 29:30 - PID"]
    #[inline(always)]
    #[must_use]
    pub fn pid(&mut self) -> PidW<Hctsiz0Spec> {
        PidW::new(self, 29)
    }
}
...
pub struct Hctsiz0Spec;
impl crate::RegisterSpec for Hctsiz0Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`hctsiz0::R`](R) reader structure"]
impl crate::Readable for Hctsiz0Spec {}
#[doc = "`write(|w| ..)` method takes [`hctsiz0::W`](W) writer structure"]
impl crate::Writable for Hctsiz0Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets HCTSIZ0 to value 0"]
impl crate::Resettable for Hctsiz0Spec {
