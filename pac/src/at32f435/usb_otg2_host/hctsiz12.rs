...
pub type R = crate::R<Hctsiz12Spec>;
#[doc = "Register `HCTSIZ12` writer"]
pub type W = crate::W<Hctsiz12Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn xfersize(&mut self) -> XfersizeW<Hctsiz12Spec> {
        XfersizeW::new(self, 0)
    }
    #[doc = "Bits 19:28 - Packet count"]
    #[inline(always)]
    #[must_use]
    pub fn pktcnt(&mut self) -> PktcntW<Hctsiz12Spec> {
        PktcntW::new(self, 19)
    }
    #[doc = "Bits 29:30 - PID"]
    #[inline(always)]
    #[must_use]
    pub fn pid(&mut self) -> PidW<Hctsiz12Spec> {
        PidW::new(self, 29)
    }
}
...
pub struct Hctsiz12Spec;
impl crate::RegisterSpec for Hctsiz12Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`hctsiz12::R`](R) reader structure"]
impl crate::Readable for Hctsiz12Spec {}
#[doc = "`write(|w| ..)` method takes [`hctsiz12::W`](W) writer structure"]
impl crate::Writable for Hctsiz12Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets HCTSIZ12 to value 0"]
impl crate::Resettable for Hctsiz12Spec {
