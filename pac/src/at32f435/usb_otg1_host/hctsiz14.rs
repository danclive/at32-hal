...
pub type R = crate::R<Hctsiz14Spec>;
#[doc = "Register `HCTSIZ14` writer"]
pub type W = crate::W<Hctsiz14Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn xfersize(&mut self) -> XfersizeW<Hctsiz14Spec> {
        XfersizeW::new(self, 0)
    }
    #[doc = "Bits 19:28 - Packet count"]
    #[inline(always)]
    #[must_use]
    pub fn pktcnt(&mut self) -> PktcntW<Hctsiz14Spec> {
        PktcntW::new(self, 19)
    }
    #[doc = "Bits 29:30 - PID"]
    #[inline(always)]
    #[must_use]
    pub fn pid(&mut self) -> PidW<Hctsiz14Spec> {
        PidW::new(self, 29)
    }
}
...
pub struct Hctsiz14Spec;
impl crate::RegisterSpec for Hctsiz14Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`hctsiz14::R`](R) reader structure"]
impl crate::Readable for Hctsiz14Spec {}
#[doc = "`write(|w| ..)` method takes [`hctsiz14::W`](W) writer structure"]
impl crate::Writable for Hctsiz14Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets HCTSIZ14 to value 0"]
impl crate::Resettable for Hctsiz14Spec {
