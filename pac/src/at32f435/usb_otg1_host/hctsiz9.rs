...
pub type R = crate::R<Hctsiz9Spec>;
#[doc = "Register `HCTSIZ9` writer"]
pub type W = crate::W<Hctsiz9Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn xfersize(&mut self) -> XfersizeW<Hctsiz9Spec> {
        XfersizeW::new(self, 0)
    }
    #[doc = "Bits 19:28 - Packet count"]
    #[inline(always)]
    #[must_use]
    pub fn pktcnt(&mut self) -> PktcntW<Hctsiz9Spec> {
        PktcntW::new(self, 19)
    }
    #[doc = "Bits 29:30 - PID"]
    #[inline(always)]
    #[must_use]
    pub fn pid(&mut self) -> PidW<Hctsiz9Spec> {
        PidW::new(self, 29)
    }
}
...
pub struct Hctsiz9Spec;
impl crate::RegisterSpec for Hctsiz9Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`hctsiz9::R`](R) reader structure"]
impl crate::Readable for Hctsiz9Spec {}
#[doc = "`write(|w| ..)` method takes [`hctsiz9::W`](W) writer structure"]
impl crate::Writable for Hctsiz9Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets HCTSIZ9 to value 0"]
impl crate::Resettable for Hctsiz9Spec {
