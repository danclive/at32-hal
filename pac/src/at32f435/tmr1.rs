...
impl RegisterBlock {
    ...
    #[inline(always)]
    pub const fn cm3_output(&self) -> &Cm3Output {
        &self.cm3_output
    }
...
pub mod dmadt;
#[doc = "CM3_OUTPUT (rw) register accessor: Channel output mode register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`cm3_output::R`].  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`cm3_output::W`]. You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@cm3_output`]
module"]
#[doc(alias = "CM3_OUTPUT")]
pub type Cm3Output = crate::Reg<cm3_output::Cm3OutputSpec>;
#[doc = "Channel output mode register"]
pub mod cm3_output;
#[doc = "C5DT (rw) register accessor: Channel 5 data register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`c5dt::R`].  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`c5dt::W`]. You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@c5dt`]
module"]
#[doc(alias = "C5DT")]
pub type C5dt = crate::Reg<c5dt::C5dtSpec>;
