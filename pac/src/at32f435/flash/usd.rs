...
pub type NWdtDepslpR = crate::BitReader;
#[doc = "Field `nWDT_STDBY` reader - WDT standby"]
pub type NWdtStdbyR = crate::BitReader;
...
impl R {
    ...
    #[inline(always)]
    pub fn n_wdt_depslp(&self) -> NWdtDepslpR {
        NWdtDepslpR::new(((self.bits >> 7) & 1) != 0)
    }
    #[doc = "Bit 8 - WDT standby"]
    #[inline(always)]
    pub fn n_wdt_stdby(&self) -> NWdtStdbyR {
        NWdtStdbyR::new(((self.bits >> 8) & 1) != 0)
    }
