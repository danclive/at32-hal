...
pub type R = crate::R<Diepctl6Spec>;
#[doc = "Register `DIEPCTL6` writer"]
pub type W = crate::W<Diepctl6Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn mps(&mut self) -> MpsW<Diepctl6Spec> {
        MpsW::new(self, 0)
    }
    #[doc = "Bit 15 - USB active endpoint"]
    #[inline(always)]
    #[must_use]
    pub fn usbacept(&mut self) -> UsbaceptW<Diepctl6Spec> {
        UsbaceptW::new(self, 15)
    }
    #[doc = "Bits 18:19 - Endpoint type"]
    #[inline(always)]
    #[must_use]
    pub fn eptype(&mut self) -> EptypeW<Diepctl6Spec> {
        EptypeW::new(self, 18)
    }
    #[doc = "Bit 21 - STALL handshake"]
    #[inline(always)]
    #[must_use]
    pub fn stall(&mut self) -> StallW<Diepctl6Spec> {
        StallW::new(self, 21)
    }
    #[doc = "Bits 22:25 - TxFIFO number"]
    #[inline(always)]
    #[must_use]
    pub fn txfnum(&mut self) -> TxfnumW<Diepctl6Spec> {
        TxfnumW::new(self, 22)
    }
    #[doc = "Bit 26 - Clear NAK"]
    #[inline(always)]
    #[must_use]
    pub fn cnak(&mut self) -> CnakW<Diepctl6Spec> {
        CnakW::new(self, 26)
    }
    #[doc = "Bit 27 - Set NAK"]
    #[inline(always)]
    #[must_use]
    pub fn snak(&mut self) -> SnakW<Diepctl6Spec> {
        SnakW::new(self, 27)
    }
    #[doc = "Bit 28 - Set DATA0 PID"]
    #[inline(always)]
    #[must_use]
    pub fn setd0pid(&mut self) -> Setd0pidW<Diepctl6Spec> {
        Setd0pidW::new(self, 28)
    }
    #[doc = "Bit 29 - Set DATA1 PID"]
    #[inline(always)]
    #[must_use]
    pub fn setd1pid(&mut self) -> Setd1pidW<Diepctl6Spec> {
        Setd1pidW::new(self, 29)
    }
    #[doc = "Bit 30 - Endpoint disable"]
    #[inline(always)]
    #[must_use]
    pub fn eptdis(&mut self) -> EptdisW<Diepctl6Spec> {
        EptdisW::new(self, 30)
    }
    #[doc = "Bit 31 - Endpoint enable"]
    #[inline(always)]
    #[must_use]
    pub fn eptena(&mut self) -> EptenaW<Diepctl6Spec> {
        EptenaW::new(self, 31)
    }
}
...
pub struct Diepctl6Spec;
impl crate::RegisterSpec for Diepctl6Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`diepctl6::R`](R) reader structure"]
impl crate::Readable for Diepctl6Spec {}
#[doc = "`write(|w| ..)` method takes [`diepctl6::W`](W) writer structure"]
impl crate::Writable for Diepctl6Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DIEPCTL6 to value 0"]
impl crate::Resettable for Diepctl6Spec {
