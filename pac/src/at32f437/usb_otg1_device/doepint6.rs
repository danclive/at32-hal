...
pub type R = crate::R<Doepint6Spec>;
#[doc = "Register `DOEPINT6` writer"]
pub type W = crate::W<Doepint6Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn xferc(&mut self) -> XfercW<Doepint6Spec> {
        XfercW::new(self, 0)
    }
    #[doc = "Bit 1 - Endpoint disabled interrupt"]
    #[inline(always)]
    #[must_use]
    pub fn eptdisd(&mut self) -> EptdisdW<Doepint6Spec> {
        EptdisdW::new(self, 1)
    }
    #[doc = "Bit 3 - SETUP phase done"]
    #[inline(always)]
    #[must_use]
    pub fn setup(&mut self) -> SetupW<Doepint6Spec> {
        SetupW::new(self, 3)
    }
    #[doc = "Bit 4 - OUT token received when endpoint disabled"]
    #[inline(always)]
    #[must_use]
    pub fn outtepd(&mut self) -> OuttepdW<Doepint6Spec> {
        OuttepdW::new(self, 4)
    }
    #[doc = "Bit 6 - Back-to-back SETUP packets received"]
    #[inline(always)]
    #[must_use]
    pub fn b2bstup(&mut self) -> B2bstupW<Doepint6Spec> {
        B2bstupW::new(self, 6)
    }
}
...
pub struct Doepint6Spec;
impl crate::RegisterSpec for Doepint6Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`doepint6::R`](R) reader structure"]
impl crate::Readable for Doepint6Spec {}
#[doc = "`write(|w| ..)` method takes [`doepint6::W`](W) writer structure"]
impl crate::Writable for Doepint6Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DOEPINT6 to value 0x80"]
impl crate::Resettable for Doepint6Spec {
