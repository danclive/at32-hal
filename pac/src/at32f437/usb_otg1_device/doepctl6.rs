...
pub type R = crate::R<Doepctl6Spec>;
#[doc = "Register `DOEPCTL6` writer"]
pub type W = crate::W<Doepctl6Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn mps(&mut self) -> MpsW<Doepctl6Spec> {
        MpsW::new(self, 0)
    }
    #[doc = "Bit 15 - USB active endpoint"]
    #[inline(always)]
    #[must_use]
    pub fn usbacept(&mut self) -> UsbaceptW<Doepctl6Spec> {
        UsbaceptW::new(self, 15)
    }
    #[doc = "Bits 18:19 - Endpoint type"]
    #[inline(always)]
    #[must_use]
    pub fn eptype(&mut self) -> EptypeW<Doepctl6Spec> {
        EptypeW::new(self, 18)
    }
    #[doc = "Bit 20 - Snoop mode"]
    #[inline(always)]
    #[must_use]
    pub fn snp(&mut self) -> SnpW<Doepctl6Spec> {
        SnpW::new(self, 20)
    }
    #[doc = "Bit 21 - STALL handshake"]
    #[inline(always)]
    #[must_use]
    pub fn stall(&mut self) -> StallW<Doepctl6Spec> {
        StallW::new(self, 21)
    }
    #[doc = "Bit 26 - Clear NAK"]
    #[inline(always)]
    #[must_use]
    pub fn cnak(&mut self) -> CnakW<Doepctl6Spec> {
        CnakW::new(self, 26)
    }
    #[doc = "Bit 27 - Set NAK"]
    #[inline(always)]
    #[must_use]
    pub fn snak(&mut self) -> SnakW<Doepctl6Spec> {
        SnakW::new(self, 27)
    }
    #[doc = "Bit 30 - Endpoint disable"]
    #[inline(always)]
    #[must_use]
    pub fn eptdis(&mut self) -> EptdisW<Doepctl6Spec> {
        EptdisW::new(self, 30)
    }
    #[doc = "Bit 31 - Endpoint enable"]
    #[inline(always)]
    #[must_use]
    pub fn eptena(&mut self) -> EptenaW<Doepctl6Spec> {
        EptenaW::new(self, 31)
    }
}
...
pub struct Doepctl6Spec;
impl crate::RegisterSpec for Doepctl6Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`doepctl6::R`](R) reader structure"]
impl crate::Readable for Doepctl6Spec {}
#[doc = "`write(|w| ..)` method takes [`doepctl6::W`](W) writer structure"]
impl crate::Writable for Doepctl6Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DOEPCTL6 to value 0"]
impl crate::Resettable for Doepctl6Spec {
