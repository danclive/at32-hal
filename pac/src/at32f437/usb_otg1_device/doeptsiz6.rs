...
pub type R = crate::R<Doeptsiz6Spec>;
#[doc = "Register `DOEPTSIZ6` writer"]
pub type W = crate::W<Doeptsiz6Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn xfersize(&mut self) -> XfersizeW<Doeptsiz6Spec> {
        XfersizeW::new(self, 0)
    }
    #[doc = "Bits 19:28 - Packet count"]
    #[inline(always)]
    #[must_use]
    pub fn pktcnt(&mut self) -> PktcntW<Doeptsiz6Spec> {
        PktcntW::new(self, 19)
    }
    #[doc = "Bits 29:30 - Received data PID"]
    #[inline(always)]
    #[must_use]
    pub fn rxdpid(&mut self) -> RxdpidW<Doeptsiz6Spec> {
        RxdpidW::new(self, 29)
    }
}
...
pub struct Doeptsiz6Spec;
impl crate::RegisterSpec for Doeptsiz6Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`doeptsiz6::R`](R) reader structure"]
impl crate::Readable for Doeptsiz6Spec {}
#[doc = "`write(|w| ..)` method takes [`doeptsiz6::W`](W) writer structure"]
impl crate::Writable for Doeptsiz6Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DOEPTSIZ6 to value 0"]
impl crate::Resettable for Doeptsiz6Spec {
