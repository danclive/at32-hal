...
pub type R = crate::R<Doepint5Spec>;
#[doc = "Register `DOEPINT5` writer"]
pub type W = crate::W<Doepint5Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn xferc(&mut self) -> XfercW<Doepint5Spec> {
        XfercW::new(self, 0)
    }
    #[doc = "Bit 1 - Endpoint disabled interrupt"]
    #[inline(always)]
    #[must_use]
    pub fn eptdisd(&mut self) -> EptdisdW<Doepint5Spec> {
        EptdisdW::new(self, 1)
    }
    #[doc = "Bit 3 - SETUP phase done"]
    #[inline(always)]
    #[must_use]
    pub fn setup(&mut self) -> SetupW<Doepint5Spec> {
        SetupW::new(self, 3)
    }
    #[doc = "Bit 4 - OUT token received when endpoint disabled"]
    #[inline(always)]
    #[must_use]
    pub fn outtepd(&mut self) -> OuttepdW<Doepint5Spec> {
        OuttepdW::new(self, 4)
    }
    #[doc = "Bit 6 - Back-to-back SETUP packets received"]
    #[inline(always)]
    #[must_use]
    pub fn b2bstup(&mut self) -> B2bstupW<Doepint5Spec> {
        B2bstupW::new(self, 6)
    }
}
...
pub struct Doepint5Spec;
impl crate::RegisterSpec for Doepint5Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`doepint5::R`](R) reader structure"]
impl crate::Readable for Doepint5Spec {}
#[doc = "`write(|w| ..)` method takes [`doepint5::W`](W) writer structure"]
impl crate::Writable for Doepint5Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DOEPINT5 to value 0x80"]
impl crate::Resettable for Doepint5Spec {
