...
pub type R = crate::R<Tm2Spec>;
#[doc = "Register `TM2` writer"]
pub type W = crate::W<Tm2Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tmrd(&mut self) -> TmrdW<Tm2Spec> {
        TmrdW::new(self, 0)
    }
    #[doc = "Bits 4:7 - Exit Self-refresh to active delay"]
    #[inline(always)]
    #[must_use]
    pub fn txsr(&mut self) -> TxsrW<Tm2Spec> {
        TxsrW::new(self, 4)
    }
    #[doc = "Bits 8:11 - Self refresh time"]
    #[inline(always)]
    #[must_use]
    pub fn tras(&mut self) -> TrasW<Tm2Spec> {
        TrasW::new(self, 8)
    }
    #[doc = "Bits 12:15 - Refresh to active delay"]
    #[inline(always)]
    #[must_use]
    pub fn trc(&mut self) -> TrcW<Tm2Spec> {
        TrcW::new(self, 12)
    }
    #[doc = "Bits 16:19 - Write Recovery delay"]
    #[inline(always)]
    #[must_use]
    pub fn twr(&mut self) -> TwrW<Tm2Spec> {
        TwrW::new(self, 16)
    }
    #[doc = "Bits 20:23 - Precharge to active delay"]
    #[inline(always)]
    #[must_use]
    pub fn trp(&mut self) -> TrpW<Tm2Spec> {
        TrpW::new(self, 20)
    }
    #[doc = "Bits 24:27 - Row active to Read/Write delay"]
    #[inline(always)]
    #[must_use]
    pub fn trcd(&mut self) -> TrcdW<Tm2Spec> {
        TrcdW::new(self, 24)
    }
}
