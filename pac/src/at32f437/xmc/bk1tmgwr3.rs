#[doc = "Register `BK1TMGWR3` reader"]
pub type R = crate::R<Bk1tmgwr3Spec>;
#[doc = "Register `BK1TMGWR3` writer"]
pub type W = crate::W<Bk1tmgwr3Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn addrst(&mut self) -> AddrstW<Bk1tmgwr3Spec> {
        AddrstW::new(self, 0)
    }
    #[doc = "Bits 4:7 - Address-hold time"]
    #[inline(always)]
    #[must_use]
    pub fn addrht(&mut self) -> AddrhtW<Bk1tmgwr3Spec> {
        AddrhtW::new(self, 4)
    }
    #[doc = "Bits 8:15 - Asynchronous data setup time"]
    #[inline(always)]
    #[must_use]
    pub fn dtst(&mut self) -> DtstW<Bk1tmgwr3Spec> {
        DtstW::new(self, 8)
    }
    #[doc = "Bits 16:19 - Bus latency"]
    #[inline(always)]
    #[must_use]
    pub fn buslat(&mut self) -> BuslatW<Bk1tmgwr3Spec> {
        BuslatW::new(self, 16)
    }
    #[doc = "Bits 28:29 - Asynchronous mode"]
    #[inline(always)]
    #[must_use]
    pub fn asyncm(&mut self) -> AsyncmW<Bk1tmgwr3Spec> {
        AsyncmW::new(self, 28)
    }
}
#[doc = "SRAM/NOR-Flash write timing registers 3\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`bk1tmgwr3::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`bk1tmgwr3::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Bk1tmgwr3Spec;
impl crate::RegisterSpec for Bk1tmgwr3Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`bk1tmgwr3::R`](R) reader structure"]
impl crate::Readable for Bk1tmgwr3Spec {}
#[doc = "`write(|w| ..)` method takes [`bk1tmgwr3::W`](W) writer structure"]
impl crate::Writable for Bk1tmgwr3Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets BK1TMGWR3 to value 0x0fff_ffff"]
impl crate::Resettable for Bk1tmgwr3Spec {
