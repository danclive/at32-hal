...
pub type R = crate::R<Ext1Spec>;
#[doc = "Register `EXT1` writer"]
pub type W = crate::W<Ext1Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn buslatw2w(&mut self) -> Buslatw2wW<Ext1Spec> {
        Buslatw2wW::new(self, 0)
    }
    #[doc = "Bits 8:15 - Bus turnaround phase for consecutive read duration"]
    #[inline(always)]
    #[must_use]
    pub fn buslatr2r(&mut self) -> Buslatr2rW<Ext1Spec> {
