...
pub type R = crate::R<Bk1tmg1Spec>;
#[doc = "Register `BK1TMG1` writer"]
pub type W = crate::W<Bk1tmg1Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn addrst(&mut self) -> AddrstW<Bk1tmg1Spec> {
        AddrstW::new(self, 0)
    }
    #[doc = "Bits 4:7 - Address-hold time"]
    #[inline(always)]
    #[must_use]
    pub fn addrht(&mut self) -> AddrhtW<Bk1tmg1Spec> {
        AddrhtW::new(self, 4)
    }
    #[doc = "Bits 8:15 - Asynchronous data setup time"]
    #[inline(always)]
    #[must_use]
    pub fn dtst(&mut self) -> DtstW<Bk1tmg1Spec> {
        DtstW::new(self, 8)
    }
    #[doc = "Bits 16:19 - Bus latency"]
    #[inline(always)]
    #[must_use]
    pub fn buslat(&mut self) -> BuslatW<Bk1tmg1Spec> {
        BuslatW::new(self, 16)
    }
    #[doc = "Bits 20:23 - Clock prescale"]
    #[inline(always)]
    #[must_use]
    pub fn clkpsc(&mut self) -> ClkpscW<Bk1tmg1Spec> {
        ClkpscW::new(self, 20)
    }
    #[doc = "Bits 24:27 - Data latency"]
    #[inline(always)]
    #[must_use]
    pub fn dtlat(&mut self) -> DtlatW<Bk1tmg1Spec> {
        DtlatW::new(self, 24)
    }
    #[doc = "Bits 28:29 - Asynchronous mode"]
    #[inline(always)]
    #[must_use]
    pub fn asyncm(&mut self) -> AsyncmW<Bk1tmg1Spec> {
        AsyncmW::new(self, 28)
    }
}
