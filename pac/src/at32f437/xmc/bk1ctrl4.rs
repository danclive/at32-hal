#[doc = "Register `BK1CTRL4` reader"]
pub type R = crate::R<Bk1ctrl4Spec>;
#[doc = "Register `BK1CTRL4` writer"]
pub type W = crate::W<Bk1ctrl4Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn en(&mut self) -> EnW<Bk1ctrl4Spec> {
        EnW::new(self, 0)
    }
    #[doc = "Bit 1 - Address and data multiplexing enable"]
    #[inline(always)]
    #[must_use]
    pub fn admuxen(&mut self) -> AdmuxenW<Bk1ctrl4Spec> {
        AdmuxenW::new(self, 1)
    }
    #[doc = "Bits 2:3 - Memory device type"]
    #[inline(always)]
    #[must_use]
    pub fn dev(&mut self) -> DevW<Bk1ctrl4Spec> {
        DevW::new(self, 2)
    }
    #[doc = "Bits 4:5 - External memory data bus width"]
    #[inline(always)]
    #[must_use]
    pub fn extmdbw(&mut self) -> ExtmdbwW<Bk1ctrl4Spec> {
        ExtmdbwW::new(self, 4)
    }
    #[doc = "Bit 6 - Nor flash access enable"]
    #[inline(always)]
    #[must_use]
    pub fn noren(&mut self) -> NorenW<Bk1ctrl4Spec> {
        NorenW::new(self, 6)
    }
    #[doc = "Bit 8 - Synchronous burst enable"]
    #[inline(always)]
    #[must_use]
    pub fn syncben(&mut self) -> SyncbenW<Bk1ctrl4Spec> {
        SyncbenW::new(self, 8)
    }
    #[doc = "Bit 9 - NWAIT polarity"]
    #[inline(always)]
    #[must_use]
    pub fn nwpol(&mut self) -> NwpolW<Bk1ctrl4Spec> {
        NwpolW::new(self, 9)
    }
    #[doc = "Bit 10 - Wrapped enable"]
    #[inline(always)]
    #[must_use]
    pub fn wrapen(&mut self) -> WrapenW<Bk1ctrl4Spec> {
        WrapenW::new(self, 10)
    }
    #[doc = "Bit 11 - Wait timing configuration"]
    #[inline(always)]
    #[must_use]
    pub fn nwtcfg(&mut self) -> NwtcfgW<Bk1ctrl4Spec> {
        NwtcfgW::new(self, 11)
    }
    #[doc = "Bit 12 - Write enable"]
    #[inline(always)]
    #[must_use]
    pub fn wen(&mut self) -> WenW<Bk1ctrl4Spec> {
        WenW::new(self, 12)
    }
    #[doc = "Bit 13 - NWAIT in synchronous transfer enable"]
    #[inline(always)]
    #[must_use]
    pub fn nwsen(&mut self) -> NwsenW<Bk1ctrl4Spec> {
        NwsenW::new(self, 13)
    }
    #[doc = "Bit 14 - Read-write timing different"]
    #[inline(always)]
    #[must_use]
    pub fn rwtd(&mut self) -> RwtdW<Bk1ctrl4Spec> {
        RwtdW::new(self, 14)
    }
    #[doc = "Bit 15 - NWAIT in asynchronous transfer enable"]
    #[inline(always)]
    #[must_use]
    pub fn nwasen(&mut self) -> NwasenW<Bk1ctrl4Spec> {
        NwasenW::new(self, 15)
    }
    #[doc = "Bits 16:18 - CRAM page size"]
    #[inline(always)]
    #[must_use]
    pub fn crpgs(&mut self) -> CrpgsW<Bk1ctrl4Spec> {
        CrpgsW::new(self, 16)
    }
    #[doc = "Bit 19 - Memory write mode control"]
    #[inline(always)]
    #[must_use]
    pub fn mwmc(&mut self) -> MwmcW<Bk1ctrl4Spec> {
        MwmcW::new(self, 19)
    }
}
#[doc = "SRAM/NOR-Flash chip-select control register 4\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`bk1ctrl4::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`bk1ctrl4::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Bk1ctrl4Spec;
impl crate::RegisterSpec for Bk1ctrl4Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`bk1ctrl4::R`](R) reader structure"]
impl crate::Readable for Bk1ctrl4Spec {}
#[doc = "`write(|w| ..)` method takes [`bk1ctrl4::W`](W) writer structure"]
impl crate::Writable for Bk1ctrl4Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets BK1CTRL4 to value 0x30d2"]
impl crate::Resettable for Bk1ctrl4Spec {
