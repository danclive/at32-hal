...
pub type R = crate::R<Tmdth1Spec>;
#[doc = "Register `TMDTH1` writer"]
pub type W = crate::W<Tmdth1Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tmdt4(&mut self) -> Tmdt4W<Tmdth1Spec> {
        Tmdt4W::new(self, 0)
    }
    #[doc = "Bits 8:15 - Transmit mailbox data byte 5"]
    #[inline(always)]
    #[must_use]
    pub fn tmdt5(&mut self) -> Tmdt5W<Tmdth1Spec> {
        Tmdt5W::new(self, 8)
    }
    #[doc = "Bits 16:23 - Transmit mailbox data byte 6"]
    #[inline(always)]
    #[must_use]
    pub fn tmdt6(&mut self) -> Tmdt6W<Tmdth1Spec> {
        Tmdt6W::new(self, 16)
    }
    #[doc = "Bits 24:31 - Transmit mailbox data byte 7"]
    #[inline(always)]
    #[must_use]
    pub fn tmdt7(&mut self) -> Tmdt7W<Tmdth1Spec> {
        Tmdt7W::new(self, 24)
    }
}
...
pub struct Tmdth1Spec;
impl crate::RegisterSpec for Tmdth1Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`tmdth1::R`](R) reader structure"]
impl crate::Readable for Tmdth1Spec {}
#[doc = "`write(|w| ..)` method takes [`tmdth1::W`](W) writer structure"]
impl crate::Writable for Tmdth1Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets TMDTH1 to value 0"]
impl crate::Resettable for Tmdth1Spec {
