...
pub type R = crate::R<D1dth12lSpec>;
#[doc = "Register `D1DTH12L` writer"]
pub type W = crate::W<D1dth12lSpec>;
#[doc = "Field `D1DT12L` reader - DAC1 12-bit left-aligned data"]
pub type D1dt12lR = crate::FieldReader<u16>;
#[doc = "Field `D1DT12L` writer - DAC1 12-bit left-aligned data"]
pub type D1dt12lW<'a, REG> = crate::FieldWriter<'a, REG, 12, u16>;
impl R {
    #[doc = "Bits 4:15 - DAC1 12-bit left-aligned data"]
    #[inline(always)]
    pub fn d1dt12l(&self) -> D1dt12lR {
        D1dt12lR::new(((self.bits >> 4) & 0x0fff) as u16)
    }
}
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("D1DTH12L")
            .field("d1dt12l", &self.d1dt12l())
            .finish()
    }
}
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn d1dt12l(&mut self) -> D1dt12lW<D1dth12lSpec> {
        D1dt12lW::new(self, 4)
    }
}
...
pub struct D1dth12lSpec;
impl crate::RegisterSpec for D1dth12lSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`d1dth12l::R`](R) reader structure"]
impl crate::Readable for D1dth12lSpec {}
#[doc = "`write(|w| ..)` method takes [`d1dth12l::W`](W) writer structure"]
impl crate::Writable for D1dth12lSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets D1DTH12L to value 0"]
impl crate::Resettable for D1dth12lSpec {
