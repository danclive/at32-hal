...
pub type R = crate::R<S1dtcntSpec>;
#[doc = "Register `S1DTCNT` writer"]
pub type W = crate::W<S1dtcntSpec>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("S1DTCNT").field("cnt", &self.cnt()).finish()
    }
}
impl W {
    #[doc = "Bits 0:15 - Number of data items to transfer"]
    #[inline(always)]
    #[must_use]
    pub fn cnt(&mut self) -> CntW<S1dtcntSpec> {
        CntW::new(self, 0)
    }
}
...
pub struct S1dtcntSpec;
impl crate::RegisterSpec for S1dtcntSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`s1dtcnt::R`](R) reader structure"]
impl crate::Readable for S1dtcntSpec {}
#[doc = "`write(|w| ..)` method takes [`s1dtcnt::W`](W) writer structure"]
impl crate::Writable for S1dtcntSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets S1DTCNT to value 0"]
impl crate::Resettable for S1dtcntSpec {
