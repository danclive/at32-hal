...
pub type R = crate::R<S1m1addrSpec>;
#[doc = "Register `S1M1ADDR` writer"]
pub type W = crate::W<S1m1addrSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn m1addr(&mut self) -> M1addrW<S1m1addrSpec> {
        M1addrW::new(self, 0)
    }
}
...
pub struct S1m1addrSpec;
impl crate::RegisterSpec for S1m1addrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`s1m1addr::R`](R) reader structure"]
impl crate::Readable for S1m1addrSpec {}
#[doc = "`write(|w| ..)` method takes [`s1m1addr::W`](W) writer structure"]
impl crate::Writable for S1m1addrSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets S1M1ADDR to value 0"]
impl crate::Resettable for S1m1addrSpec {
