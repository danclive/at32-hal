...
pub type R = crate::R<S6ctrlSpec>;
#[doc = "Register `S6CTRL` writer"]
pub type W = crate::W<S6ctrlSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn sen(&mut self) -> SenW<S6ctrlSpec> {
        SenW::new(self, 0)
    }
    #[doc = "Bit 1 - Direct mode error interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn dmerrien(&mut self) -> DmerrienW<S6ctrlSpec> {
        DmerrienW::new(self, 1)
    }
    #[doc = "Bit 2 - Transfer error interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn dterrien(&mut self) -> DterrienW<S6ctrlSpec> {
        DterrienW::new(self, 2)
    }
    #[doc = "Bit 3 - Half data transfer interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn hdtien(&mut self) -> HdtienW<S6ctrlSpec> {
        HdtienW::new(self, 3)
    }
    #[doc = "Bit 4 - Full data transfer complete interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn fdtien(&mut self) -> FdtienW<S6ctrlSpec> {
        FdtienW::new(self, 4)
    }
    #[doc = "Bit 5 - Peripheral flow controller"]
    #[inline(always)]
    #[must_use]
    pub fn pfctrl(&mut self) -> PfctrlW<S6ctrlSpec> {
        PfctrlW::new(self, 5)
    }
    #[doc = "Bits 6:7 - Data transfer direction"]
    #[inline(always)]
    #[must_use]
    pub fn dtd(&mut self) -> DtdW<S6ctrlSpec> {
        DtdW::new(self, 6)
    }
    #[doc = "Bit 8 - Loop mode"]
    #[inline(always)]
    #[must_use]
    pub fn lm(&mut self) -> LmW<S6ctrlSpec> {
        LmW::new(self, 8)
    }
    #[doc = "Bit 9 - Peripheral increment mode"]
    #[inline(always)]
    #[must_use]
    pub fn pincm(&mut self) -> PincmW<S6ctrlSpec> {
        PincmW::new(self, 9)
    }
    #[doc = "Bit 10 - Memory increment mode"]
    #[inline(always)]
    #[must_use]
    pub fn mincm(&mut self) -> MincmW<S6ctrlSpec> {
        MincmW::new(self, 10)
    }
    #[doc = "Bits 11:12 - Peripheral data width"]
    #[inline(always)]
    #[must_use]
    pub fn pwidth(&mut self) -> PwidthW<S6ctrlSpec> {
        PwidthW::new(self, 11)
    }
    #[doc = "Bits 13:14 - Memory data width"]
    #[inline(always)]
    #[must_use]
    pub fn mwidth(&mut self) -> MwidthW<S6ctrlSpec> {
        MwidthW::new(self, 13)
    }
    #[doc = "Bit 15 - Peripheral increment offset size"]
    #[inline(always)]
    #[must_use]
    pub fn pincos(&mut self) -> PincosW<S6ctrlSpec> {
        PincosW::new(self, 15)
    }
    #[doc = "Bits 16:17 - Stream priority level"]
    #[inline(always)]
    #[must_use]
    pub fn spl(&mut self) -> SplW<S6ctrlSpec> {
        SplW::new(self, 16)
    }
    #[doc = "Bit 18 - Double memory mode"]
    #[inline(always)]
    #[must_use]
    pub fn dmm(&mut self) -> DmmW<S6ctrlSpec> {
        DmmW::new(self, 18)
    }
    #[doc = "Bit 19 - Current memory (only in double buffer mode)"]
    #[inline(always)]
    #[must_use]
    pub fn cm(&mut self) -> CmW<S6ctrlSpec> {
        CmW::new(self, 19)
    }
    #[doc = "Bits 21:22 - Peripheral burst transmission"]
    #[inline(always)]
    #[must_use]
    pub fn pburst(&mut self) -> PburstW<S6ctrlSpec> {
        PburstW::new(self, 21)
    }
    #[doc = "Bits 23:24 - Memory burst transmission"]
    #[inline(always)]
    #[must_use]
    pub fn mburst(&mut self) -> MburstW<S6ctrlSpec> {
        MburstW::new(self, 23)
    }
}
#[doc = "stream 6 control register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`s6ctrl::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`s6ctrl::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct S6ctrlSpec;
impl crate::RegisterSpec for S6ctrlSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`s6ctrl::R`](R) reader structure"]
impl crate::Readable for S6ctrlSpec {}
#[doc = "`write(|w| ..)` method takes [`s6ctrl::W`](W) writer structure"]
impl crate::Writable for S6ctrlSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets S6CTRL to value 0"]
impl crate::Resettable for S6ctrlSpec {
