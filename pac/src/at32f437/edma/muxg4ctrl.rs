...
pub type R = crate::R<Muxg4ctrlSpec>;
#[doc = "Register `MUXG4CTRL` writer"]
pub type W = crate::W<Muxg4ctrlSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn sigsel(&mut self) -> SigselW<Muxg4ctrlSpec> {
        SigselW::new(self, 0)
    }
    #[doc = "Bit 8 - Trigger overrun interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn trgovien(&mut self) -> TrgovienW<Muxg4ctrlSpec> {
        TrgovienW::new(self, 8)
    }
    #[doc = "Bit 16 - DMA request generator enable"]
    #[inline(always)]
    #[must_use]
    pub fn gen(&mut self) -> GenW<Muxg4ctrlSpec> {
        GenW::new(self, 16)
    }
    #[doc = "Bits 17:18 - DMA request generator trigger polarity"]
    #[inline(always)]
    #[must_use]
    pub fn gpol(&mut self) -> GpolW<Muxg4ctrlSpec> {
        GpolW::new(self, 17)
    }
    #[doc = "Bits 19:23 - Number of DMA requests to be generated"]
    #[inline(always)]
    #[must_use]
    pub fn greqcnt(&mut self) -> GreqcntW<Muxg4ctrlSpec> {
...
pub struct Muxg4ctrlSpec;
impl crate::RegisterSpec for Muxg4ctrlSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`muxg4ctrl::R`](R) reader structure"]
impl crate::Readable for Muxg4ctrlSpec {}
#[doc = "`write(|w| ..)` method takes [`muxg4ctrl::W`](W) writer structure"]
impl crate::Writable for Muxg4ctrlSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets MUXG4CTRL to value 0"]
impl crate::Resettable for Muxg4ctrlSpec {
