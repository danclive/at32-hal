#[doc = "Register `S2_2DCNT` reader"]
pub type R = crate::R<S2_2dcntSpec>;
#[doc = "Register `S2_2DCNT` writer"]
pub type W = crate::W<S2_2dcntSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn xconut(&mut self) -> XconutW<S2_2dcntSpec> {
        XconutW::new(self, 0)
    }
    #[doc = "Bits 16:31 - Y dimension transfer count"]
    #[inline(always)]
    #[must_use]
    pub fn yconut(&mut self) -> YconutW<S2_2dcntSpec> {
        YconutW::new(self, 16)
    }
}
#[doc = "Stream 2 2D Transfer Count\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`s2_2dcnt::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`s2_2dcnt::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct S2_2dcntSpec;
impl crate::RegisterSpec for S2_2dcntSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`s2_2dcnt::R`](R) reader structure"]
impl crate::Readable for S2_2dcntSpec {}
#[doc = "`write(|w| ..)` method takes [`s2_2dcnt::W`](W) writer structure"]
impl crate::Writable for S2_2dcntSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets S2_2DCNT to value 0"]
impl crate::Resettable for S2_2dcntSpec {
