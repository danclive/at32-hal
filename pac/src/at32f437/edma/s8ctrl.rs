#[doc = "Register `S8CTRL` reader"]
pub type R = crate::R<S8ctrlSpec>;
#[doc = "Register `S8CTRL` writer"]
pub type W = crate::W<S8ctrlSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn sen(&mut self) -> SenW<S8ctrlSpec> {
        SenW::new(self, 0)
    }
    #[doc = "Bit 1 - Direct mode error interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn dmerrien(&mut self) -> DmerrienW<S8ctrlSpec> {
        DmerrienW::new(self, 1)
    }
    #[doc = "Bit 2 - Transfer error interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn dterrien(&mut self) -> DterrienW<S8ctrlSpec> {
        DterrienW::new(self, 2)
    }
    #[doc = "Bit 3 - Half data transfer interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn hdtien(&mut self) -> HdtienW<S8ctrlSpec> {
        HdtienW::new(self, 3)
    }
    #[doc = "Bit 4 - Full data transfer complete interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn fdtien(&mut self) -> FdtienW<S8ctrlSpec> {
        FdtienW::new(self, 4)
    }
    #[doc = "Bit 5 - Peripheral flow controller"]
    #[inline(always)]
    #[must_use]
    pub fn pfctrl(&mut self) -> PfctrlW<S8ctrlSpec> {
        PfctrlW::new(self, 5)
    }
    #[doc = "Bits 6:7 - Data transfer direction"]
    #[inline(always)]
    #[must_use]
    pub fn dtd(&mut self) -> DtdW<S8ctrlSpec> {
        DtdW::new(self, 6)
    }
    #[doc = "Bit 8 - Loop mode"]
    #[inline(always)]
    #[must_use]
    pub fn lm(&mut self) -> LmW<S8ctrlSpec> {
        LmW::new(self, 8)
    }
    #[doc = "Bit 9 - Peripheral increment mode"]
    #[inline(always)]
    #[must_use]
    pub fn pincm(&mut self) -> PincmW<S8ctrlSpec> {
        PincmW::new(self, 9)
    }
    #[doc = "Bit 10 - Memory increment mode"]
    #[inline(always)]
    #[must_use]
    pub fn mincm(&mut self) -> MincmW<S8ctrlSpec> {
        MincmW::new(self, 10)
    }
    #[doc = "Bits 11:12 - Peripheral data width"]
    #[inline(always)]
    #[must_use]
    pub fn pwidth(&mut self) -> PwidthW<S8ctrlSpec> {
        PwidthW::new(self, 11)
    }
    #[doc = "Bits 13:14 - Memory data width"]
    #[inline(always)]
    #[must_use]
    pub fn mwidth(&mut self) -> MwidthW<S8ctrlSpec> {
        MwidthW::new(self, 13)
    }
    #[doc = "Bit 15 - Peripheral increment offset size"]
    #[inline(always)]
    #[must_use]
    pub fn pincos(&mut self) -> PincosW<S8ctrlSpec> {
        PincosW::new(self, 15)
    }
    #[doc = "Bits 16:17 - Stream priority level"]
    #[inline(always)]
    #[must_use]
    pub fn spl(&mut self) -> SplW<S8ctrlSpec> {
        SplW::new(self, 16)
    }
    #[doc = "Bit 18 - Double memory mode"]
    #[inline(always)]
    #[must_use]
    pub fn dmm(&mut self) -> DmmW<S8ctrlSpec> {
        DmmW::new(self, 18)
    }
    #[doc = "Bit 19 - Current memory (only in double buffer mode)"]
    #[inline(always)]
    #[must_use]
    pub fn cm(&mut self) -> CmW<S8ctrlSpec> {
        CmW::new(self, 19)
    }
    #[doc = "Bits 21:22 - Peripheral burst transmission"]
    #[inline(always)]
    #[must_use]
    pub fn pburst(&mut self) -> PburstW<S8ctrlSpec> {
        PburstW::new(self, 21)
    }
    #[doc = "Bits 23:24 - Memory burst transmission"]
    #[inline(always)]
    #[must_use]
    pub fn mburst(&mut self) -> MburstW<S8ctrlSpec> {
        MburstW::new(self, 23)
    }
}
#[doc = "stream 8 control register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`s8ctrl::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`s8ctrl::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct S8ctrlSpec;
impl crate::RegisterSpec for S8ctrlSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`s8ctrl::R`](R) reader structure"]
impl crate::Readable for S8ctrlSpec {}
#[doc = "`write(|w| ..)` method takes [`s8ctrl::W`](W) writer structure"]
impl crate::Writable for S8ctrlSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets S8CTRL to value 0"]
impl crate::Resettable for S8ctrlSpec {
