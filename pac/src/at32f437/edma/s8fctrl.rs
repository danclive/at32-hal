#[doc = "Register `S8FCTRL` reader"]
pub type R = crate::R<S8fctrlSpec>;
#[doc = "Register `S8FCTRL` writer"]
pub type W = crate::W<S8fctrlSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn fthsel(&mut self) -> FthselW<S8fctrlSpec> {
        FthselW::new(self, 0)
    }
    #[doc = "Bit 2 - FIFO mode enable"]
    #[inline(always)]
    #[must_use]
    pub fn fen(&mut self) -> FenW<S8fctrlSpec> {
        FenW::new(self, 2)
    }
    #[doc = "Bit 7 - FIFO error interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn ferrien(&mut self) -> FerrienW<S8fctrlSpec> {
        FerrienW::new(self, 7)
    }
}
#[doc = "stream 8 FIFO control register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`s8fctrl::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`s8fctrl::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct S8fctrlSpec;
impl crate::RegisterSpec for S8fctrlSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`s8fctrl::R`](R) reader structure"]
impl crate::Readable for S8fctrlSpec {}
#[doc = "`write(|w| ..)` method takes [`s8fctrl::W`](W) writer structure"]
impl crate::Writable for S8fctrlSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets S8FCTRL to value 0x21"]
impl crate::Resettable for S8fctrlSpec {
