...
pub type R = crate::R<S4llpSpec>;
#[doc = "Register `S4LLP` writer"]
pub type W = crate::W<S4llpSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn llp(&mut self) -> LlpW<S4llpSpec> {
        LlpW::new(self, 0)
    }
}
...
pub struct S4llpSpec;
impl crate::RegisterSpec for S4llpSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`s4llp::R`](R) reader structure"]
impl crate::Readable for S4llpSpec {}
#[doc = "`write(|w| ..)` method takes [`s4llp::W`](W) writer structure"]
impl crate::Writable for S4llpSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets S4LLP to value 0"]
impl crate::Resettable for S4llpSpec {
