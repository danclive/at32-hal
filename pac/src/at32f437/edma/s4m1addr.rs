...
pub type R = crate::R<S4m1addrSpec>;
#[doc = "Register `S4M1ADDR` writer"]
pub type W = crate::W<S4m1addrSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn m1addr(&mut self) -> M1addrW<S4m1addrSpec> {
        M1addrW::new(self, 0)
    }
}
...
pub struct S4m1addrSpec;
impl crate::RegisterSpec for S4m1addrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`s4m1addr::R`](R) reader structure"]
impl crate::Readable for S4m1addrSpec {}
#[doc = "`write(|w| ..)` method takes [`s4m1addr::W`](W) writer structure"]
impl crate::Writable for S4m1addrSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets S4M1ADDR to value 0"]
impl crate::Resettable for S4m1addrSpec {
