...
pub type R = crate::R<S6fctrlSpec>;
#[doc = "Register `S6FCTRL` writer"]
pub type W = crate::W<S6fctrlSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn fthsel(&mut self) -> FthselW<S6fctrlSpec> {
        FthselW::new(self, 0)
    }
    #[doc = "Bit 2 - FIFO mode enable"]
    #[inline(always)]
    #[must_use]
    pub fn fen(&mut self) -> FenW<S6fctrlSpec> {
        FenW::new(self, 2)
    }
    #[doc = "Bit 7 - FIFO error interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn ferrien(&mut self) -> FerrienW<S6fctrlSpec> {
        FerrienW::new(self, 7)
    }
}
...
pub struct S6fctrlSpec;
impl crate::RegisterSpec for S6fctrlSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`s6fctrl::R`](R) reader structure"]
impl crate::Readable for S6fctrlSpec {}
#[doc = "`write(|w| ..)` method takes [`s6fctrl::W`](W) writer structure"]
impl crate::Writable for S6fctrlSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets S6FCTRL to value 0x21"]
impl crate::Resettable for S6fctrlSpec {
