...
pub type R = crate::R<S6paddrSpec>;
#[doc = "Register `S6PADDR` writer"]
pub type W = crate::W<S6paddrSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn paddr(&mut self) -> PaddrW<S6paddrSpec> {
        PaddrW::new(self, 0)
    }
}
...
pub struct S6paddrSpec;
impl crate::RegisterSpec for S6paddrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`s6paddr::R`](R) reader structure"]
impl crate::Readable for S6paddrSpec {}
#[doc = "`write(|w| ..)` method takes [`s6paddr::W`](W) writer structure"]
impl crate::Writable for S6paddrSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets S6PADDR to value 0"]
impl crate::Resettable for S6paddrSpec {
