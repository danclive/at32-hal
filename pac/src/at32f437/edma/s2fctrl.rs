...
pub type R = crate::R<S2fctrlSpec>;
#[doc = "Register `S2FCTRL` writer"]
pub type W = crate::W<S2fctrlSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn fthsel(&mut self) -> FthselW<S2fctrlSpec> {
        FthselW::new(self, 0)
    }
    #[doc = "Bit 2 - FIFO mode enable"]
    #[inline(always)]
    #[must_use]
    pub fn fen(&mut self) -> FenW<S2fctrlSpec> {
        FenW::new(self, 2)
    }
    #[doc = "Bit 7 - FIFO error interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn ferrien(&mut self) -> FerrienW<S2fctrlSpec> {
        FerrienW::new(self, 7)
    }
}
#[doc = "stream 2 FIFO control register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`s2fctrl::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`s2fctrl::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct S2fctrlSpec;
impl crate::RegisterSpec for S2fctrlSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`s2fctrl::R`](R) reader structure"]
impl crate::Readable for S2fctrlSpec {}
#[doc = "`write(|w| ..)` method takes [`s2fctrl::W`](W) writer structure"]
impl crate::Writable for S2fctrlSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets S2FCTRL to value 0x21"]
impl crate::Resettable for S2fctrlSpec {
