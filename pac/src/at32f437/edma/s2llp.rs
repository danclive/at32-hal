...
pub type R = crate::R<S2llpSpec>;
#[doc = "Register `S2LLP` writer"]
pub type W = crate::W<S2llpSpec>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("S2LLP").field("llp", &self.llp()).finish()
    }
}
impl W {
    #[doc = "Bits 0:31 - Link list pointer"]
    #[inline(always)]
    #[must_use]
    pub fn llp(&mut self) -> LlpW<S2llpSpec> {
        LlpW::new(self, 0)
    }
}
...
pub struct S2llpSpec;
impl crate::RegisterSpec for S2llpSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`s2llp::R`](R) reader structure"]
impl crate::Readable for S2llpSpec {}
#[doc = "`write(|w| ..)` method takes [`s2llp::W`](W) writer structure"]
impl crate::Writable for S2llpSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets S2LLP to value 0"]
impl crate::Resettable for S2llpSpec {
