...
pub type R = crate::R<Muxs1ctrlSpec>;
#[doc = "Register `MUXS1CTRL` writer"]
pub type W = crate::W<Muxs1ctrlSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn reqsel(&mut self) -> ReqselW<Muxs1ctrlSpec> {
        ReqselW::new(self, 0)
    }
    #[doc = "Bit 8 - Synchronization overrun interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn syncovien(&mut self) -> SyncovienW<Muxs1ctrlSpec> {
        SyncovienW::new(self, 8)
    }
    #[doc = "Bit 9 - Event generation enable"]
    #[inline(always)]
    #[must_use]
    pub fn evtgen(&mut self) -> EvtgenW<Muxs1ctrlSpec> {
        EvtgenW::new(self, 9)
    }
    #[doc = "Bit 16 - Synchroniztion enable"]
    #[inline(always)]
    #[must_use]
    pub fn syncen(&mut self) -> SyncenW<Muxs1ctrlSpec> {
        SyncenW::new(self, 16)
    }
    #[doc = "Bits 17:18 - Synchronization polarity"]
    #[inline(always)]
    #[must_use]
    pub fn syncpol(&mut self) -> SyncpolW<Muxs1ctrlSpec> {
        SyncpolW::new(self, 17)
    }
    #[doc = "Bits 19:23 - Number of DMA requests"]
    #[inline(always)]
    #[must_use]
    pub fn reqcnt(&mut self) -> ReqcntW<Muxs1ctrlSpec> {
        ReqcntW::new(self, 19)
    }
    #[doc = "Bits 24:28 - Synchronization select"]
    #[inline(always)]
    #[must_use]
    pub fn syncsel(&mut self) -> SyncselW<Muxs1ctrlSpec> {
...
pub struct Muxs1ctrlSpec;
impl crate::RegisterSpec for Muxs1ctrlSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`muxs1ctrl::R`](R) reader structure"]
impl crate::Readable for Muxs1ctrlSpec {}
#[doc = "`write(|w| ..)` method takes [`muxs1ctrl::W`](W) writer structure"]
impl crate::Writable for Muxs1ctrlSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets MUXS1CTRL to value 0"]
impl crate::Resettable for Muxs1ctrlSpec {
