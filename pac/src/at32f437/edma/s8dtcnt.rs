...
pub type R = crate::R<S8dtcntSpec>;
#[doc = "Register `S8DTCNT` writer"]
pub type W = crate::W<S8dtcntSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cnt(&mut self) -> CntW<S8dtcntSpec> {
        CntW::new(self, 0)
    }
}
...
pub struct S8dtcntSpec;
impl crate::RegisterSpec for S8dtcntSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`s8dtcnt::R`](R) reader structure"]
impl crate::Readable for S8dtcntSpec {}
#[doc = "`write(|w| ..)` method takes [`s8dtcnt::W`](W) writer structure"]
impl crate::Writable for S8dtcntSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets S8DTCNT to value 0"]
impl crate::Resettable for S8dtcntSpec {
