...
pub type R = crate::R<S1fctrlSpec>;
#[doc = "Register `S1FCTRL` writer"]
pub type W = crate::W<S1fctrlSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn fthsel(&mut self) -> FthselW<S1fctrlSpec> {
        FthselW::new(self, 0)
    }
    #[doc = "Bit 2 - FIFO mode enable"]
    #[inline(always)]
    #[must_use]
    pub fn fen(&mut self) -> FenW<S1fctrlSpec> {
        FenW::new(self, 2)
    }
    #[doc = "Bit 7 - FIFO error interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn ferrien(&mut self) -> FerrienW<S1fctrlSpec> {
        FerrienW::new(self, 7)
    }
}
...
pub struct S1fctrlSpec;
impl crate::RegisterSpec for S1fctrlSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`s1fctrl::R`](R) reader structure"]
impl crate::Readable for S1fctrlSpec {}
#[doc = "`write(|w| ..)` method takes [`s1fctrl::W`](W) writer structure"]
impl crate::Writable for S1fctrlSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets S1FCTRL to value 0x21"]
impl crate::Resettable for S1fctrlSpec {
