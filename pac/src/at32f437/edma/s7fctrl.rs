...
pub type R = crate::R<S7fctrlSpec>;
#[doc = "Register `S7FCTRL` writer"]
pub type W = crate::W<S7fctrlSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn fthsel(&mut self) -> FthselW<S7fctrlSpec> {
        FthselW::new(self, 0)
    }
    #[doc = "Bit 2 - FIFO mode enable"]
    #[inline(always)]
    #[must_use]
    pub fn fen(&mut self) -> FenW<S7fctrlSpec> {
        FenW::new(self, 2)
    }
    #[doc = "Bit 7 - FIFO error interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn ferrien(&mut self) -> FerrienW<S7fctrlSpec> {
        FerrienW::new(self, 7)
    }
}
...
pub struct S7fctrlSpec;
impl crate::RegisterSpec for S7fctrlSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`s7fctrl::R`](R) reader structure"]
impl crate::Readable for S7fctrlSpec {}
#[doc = "`write(|w| ..)` method takes [`s7fctrl::W`](W) writer structure"]
impl crate::Writable for S7fctrlSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets S7FCTRL to value 0x21"]
impl crate::Resettable for S7fctrlSpec {
