...
pub type R = crate::R<Hcintmsk1Spec>;
#[doc = "Register `HCINTMSK1` writer"]
pub type W = crate::W<Hcintmsk1Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn xfercmsk(&mut self) -> XfercmskW<Hcintmsk1Spec> {
        XfercmskW::new(self, 0)
    }
    #[doc = "Bit 1 - Channel halted mask"]
    #[inline(always)]
    #[must_use]
    pub fn chhltdmsk(&mut self) -> ChhltdmskW<Hcintmsk1Spec> {
        ChhltdmskW::new(self, 1)
    }
    #[doc = "Bit 3 - STALL response received interrupt mask"]
    #[inline(always)]
    #[must_use]
    pub fn stallmsk(&mut self) -> StallmskW<Hcintmsk1Spec> {
        StallmskW::new(self, 3)
    }
    #[doc = "Bit 4 - NAK response received interrupt mask"]
    #[inline(always)]
    #[must_use]
    pub fn nakmsk(&mut self) -> NakmskW<Hcintmsk1Spec> {
        NakmskW::new(self, 4)
    }
    #[doc = "Bit 5 - ACK response received/transmitted interrupt mask"]
    #[inline(always)]
    #[must_use]
    pub fn ackmsk(&mut self) -> AckmskW<Hcintmsk1Spec> {
        AckmskW::new(self, 5)
    }
    #[doc = "Bit 7 - Transaction error mask"]
    #[inline(always)]
    #[must_use]
    pub fn xacterrmsk(&mut self) -> XacterrmskW<Hcintmsk1Spec> {
        XacterrmskW::new(self, 7)
    }
    #[doc = "Bit 8 - Babble error mask"]
    #[inline(always)]
    #[must_use]
    pub fn bblerrmsk(&mut self) -> BblerrmskW<Hcintmsk1Spec> {
        BblerrmskW::new(self, 8)
    }
    #[doc = "Bit 9 - Frame overrun mask"]
    #[inline(always)]
    #[must_use]
    pub fn frmovrunmsk(&mut self) -> FrmovrunmskW<Hcintmsk1Spec> {
        FrmovrunmskW::new(self, 9)
    }
    #[doc = "Bit 10 - Data toggle error mask"]
    #[inline(always)]
    #[must_use]
    pub fn dtglerrmsk(&mut self) -> DtglerrmskW<Hcintmsk1Spec> {
...
pub struct Hcintmsk1Spec;
impl crate::RegisterSpec for Hcintmsk1Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`hcintmsk1::R`](R) reader structure"]
impl crate::Readable for Hcintmsk1Spec {}
#[doc = "`write(|w| ..)` method takes [`hcintmsk1::W`](W) writer structure"]
impl crate::Writable for Hcintmsk1Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets HCINTMSK1 to value 0"]
impl crate::Resettable for Hcintmsk1Spec {
