...
pub type R = crate::R<Hctsiz7Spec>;
#[doc = "Register `HCTSIZ7` writer"]
pub type W = crate::W<Hctsiz7Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn xfersize(&mut self) -> XfersizeW<Hctsiz7Spec> {
        XfersizeW::new(self, 0)
    }
    #[doc = "Bits 19:28 - Packet count"]
    #[inline(always)]
    #[must_use]
    pub fn pktcnt(&mut self) -> PktcntW<Hctsiz7Spec> {
        PktcntW::new(self, 19)
    }
    #[doc = "Bits 29:30 - PID"]
    #[inline(always)]
    #[must_use]
    pub fn pid(&mut self) -> PidW<Hctsiz7Spec> {
        PidW::new(self, 29)
    }
}
...
pub struct Hctsiz7Spec;
impl crate::RegisterSpec for Hctsiz7Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`hctsiz7::R`](R) reader structure"]
impl crate::Readable for Hctsiz7Spec {}
#[doc = "`write(|w| ..)` method takes [`hctsiz7::W`](W) writer structure"]
impl crate::Writable for Hctsiz7Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets HCTSIZ7 to value 0"]
impl crate::Resettable for Hctsiz7Spec {
