...
pub type R = crate::R<Muxc6ctrlSpec>;
#[doc = "Register `MUXC6CTRL` writer"]
pub type W = crate::W<Muxc6ctrlSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn reqsel(&mut self) -> ReqselW<Muxc6ctrlSpec> {
        ReqselW::new(self, 0)
    }
    #[doc = "Bit 8 - Synchronization overrun interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn syncovien(&mut self) -> SyncovienW<Muxc6ctrlSpec> {
        SyncovienW::new(self, 8)
    }
    #[doc = "Bit 9 - Event generation enable"]
    #[inline(always)]
    #[must_use]
    pub fn evtgen(&mut self) -> EvtgenW<Muxc6ctrlSpec> {
        EvtgenW::new(self, 9)
    }
    #[doc = "Bit 16 - Synchroniztion enable"]
    #[inline(always)]
    #[must_use]
    pub fn syncen(&mut self) -> SyncenW<Muxc6ctrlSpec> {
        SyncenW::new(self, 16)
    }
    #[doc = "Bits 17:18 - Synchronization polarity"]
    #[inline(always)]
    #[must_use]
    pub fn syncpol(&mut self) -> SyncpolW<Muxc6ctrlSpec> {
        SyncpolW::new(self, 17)
    }
    #[doc = "Bits 19:23 - Number of DMA requests"]
    #[inline(always)]
    #[must_use]
    pub fn reqcnt(&mut self) -> ReqcntW<Muxc6ctrlSpec> {
        ReqcntW::new(self, 19)
    }
    #[doc = "Bits 24:28 - Synchronization Identification"]
    #[inline(always)]
    #[must_use]
    pub fn syncsel(&mut self) -> SyncselW<Muxc6ctrlSpec> {
...
pub struct Muxc6ctrlSpec;
impl crate::RegisterSpec for Muxc6ctrlSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`muxc6ctrl::R`](R) reader structure"]
impl crate::Readable for Muxc6ctrlSpec {}
#[doc = "`write(|w| ..)` method takes [`muxc6ctrl::W`](W) writer structure"]
impl crate::Writable for Muxc6ctrlSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets MUXC6CTRL to value 0"]
impl crate::Resettable for Muxc6ctrlSpec {
