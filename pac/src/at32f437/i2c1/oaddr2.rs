...
pub type Addr2maskR = crate::FieldReader;
#[doc = "Field `ADDR2MASK` writer - Own address 2-bit mask"]
pub type Addr2maskW<'a, REG> = crate::FieldWriter<'a, REG, 3>;
...
impl R {
    ...
    #[inline(always)]
    pub fn addr2mask(&self) -> Addr2maskR {
        Addr2maskR::new(((self.bits >> 8) & 7) as u8)
    }
    #[doc = "Bit 15 - Own address 2 enable"]
    #[inline(always)]
    pub fn addr2en(&self) -> Addr2enR {
        Addr2enR::new(((self.bits >> 15) & 1) != 0)
    }
}
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn addr2mask(&mut self) -> Addr2maskW<Oaddr2Spec> {
        Addr2maskW::new(self, 8)
    }
    #[doc = "Bit 15 - Own address 2 enable"]
    #[inline(always)]
    #[must_use]
    pub fn addr2en(&mut self) -> Addr2enW<Oaddr2Spec> {
        Addr2enW::new(self, 15)
    }
}
