...
pub type Addr1enR = crate::BitReader;
#[doc = "Field `ADDR1EN` writer - Own address 1 enable"]
pub type Addr1enW<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ...
    pub fn addr1mode(&self) -> Addr1modeR {
        Addr1modeR::new(((self.bits >> 10) & 1) != 0)
    }
    #[doc = "Bit 15 - Own address 1 enable"]
    #[inline(always)]
    pub fn addr1en(&self) -> Addr1enR {
        Addr1enR::new(((self.bits >> 15) & 1) != 0)
    }
}
...
impl W {
    ...
    pub fn addr1mode(&mut self) -> Addr1modeW<Oaddr1Spec> {
        Addr1modeW::new(self, 10)
    }
    #[doc = "Bit 15 - Own address 1 enable"]
    #[inline(always)]
    #[must_use]
    pub fn addr1en(&mut self) -> Addr1enW<Oaddr1Spec> {
        Addr1enW::new(self, 15)
    }
}
