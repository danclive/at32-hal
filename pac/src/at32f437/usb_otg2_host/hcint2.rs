...
pub type R = crate::R<Hcint2Spec>;
#[doc = "Register `HCINT2` writer"]
pub type W = crate::W<Hcint2Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn xferc(&mut self) -> XfercW<Hcint2Spec> {
        XfercW::new(self, 0)
    }
    #[doc = "Bit 1 - Channel halted"]
    #[inline(always)]
    #[must_use]
    pub fn chhltd(&mut self) -> ChhltdW<Hcint2Spec> {
        ChhltdW::new(self, 1)
    }
    #[doc = "Bit 3 - STALL response received interrupt"]
    #[inline(always)]
    #[must_use]
    pub fn stall(&mut self) -> StallW<Hcint2Spec> {
        StallW::new(self, 3)
    }
    #[doc = "Bit 4 - NAK response received interrupt"]
    #[inline(always)]
    #[must_use]
    pub fn nak(&mut self) -> NakW<Hcint2Spec> {
        NakW::new(self, 4)
    }
    #[doc = "Bit 5 - ACK response received/transmitted interrupt"]
    #[inline(always)]
    #[must_use]
    pub fn ack(&mut self) -> AckW<Hcint2Spec> {
        AckW::new(self, 5)
    }
    #[doc = "Bit 7 - Transaction error"]
    #[inline(always)]
    #[must_use]
    pub fn xacterr(&mut self) -> XacterrW<Hcint2Spec> {
        XacterrW::new(self, 7)
    }
    #[doc = "Bit 8 - Babble error"]
    #[inline(always)]
    #[must_use]
    pub fn bblerr(&mut self) -> BblerrW<Hcint2Spec> {
        BblerrW::new(self, 8)
    }
    #[doc = "Bit 9 - Frame overrun"]
    #[inline(always)]
    #[must_use]
    pub fn frmovrun(&mut self) -> FrmovrunW<Hcint2Spec> {
        FrmovrunW::new(self, 9)
    }
    #[doc = "Bit 10 - Data toggle error"]
    #[inline(always)]
    #[must_use]
    pub fn dtglerr(&mut self) -> DtglerrW<Hcint2Spec> {
...
pub struct Hcint2Spec;
impl crate::RegisterSpec for Hcint2Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`hcint2::R`](R) reader structure"]
impl crate::Readable for Hcint2Spec {}
#[doc = "`write(|w| ..)` method takes [`hcint2::W`](W) writer structure"]
impl crate::Writable for Hcint2Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets HCINT2 to value 0"]
impl crate::Resettable for Hcint2Spec {
