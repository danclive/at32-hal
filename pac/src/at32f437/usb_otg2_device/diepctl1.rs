...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn mps(&mut self) -> MpsW<Diepctl1Spec> {
        MpsW::new(self, 0)
    }
    #[doc = "Bit 15 - USB active endpoint"]
    #[inline(always)]
    #[must_use]
    pub fn usbacept(&mut self) -> UsbaceptW<Diepctl1Spec> {
        UsbaceptW::new(self, 15)
    }
    #[doc = "Bits 18:19 - Endpoint type"]
    #[inline(always)]
    #[must_use]
    pub fn eptype(&mut self) -> EptypeW<Diepctl1Spec> {
        EptypeW::new(self, 18)
    }
    #[doc = "Bit 21 - STALL handshake"]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn setd0pid(&mut self) -> Setd0pidW<Diepctl1Spec> {
        Setd0pidW::new(self, 28)
    }
    #[doc = "Bit 29 - Set DATA1 PID"]
    #[inline(always)]
    #[must_use]
    pub fn setd1pid(&mut self) -> Setd1pidW<Diepctl1Spec> {
        Setd1pidW::new(self, 29)
    }
    #[doc = "Bit 30 - Endpoint disable"]
    #[inline(always)]
    #[must_use]
    pub fn eptdis(&mut self) -> EptdisW<Diepctl1Spec> {
        EptdisW::new(self, 30)
    }
    #[doc = "Bit 31 - Endpoint enable"]
    #[inline(always)]
    #[must_use]
    pub fn eptena(&mut self) -> EptenaW<Diepctl1Spec> {
        EptenaW::new(self, 31)
    }
}
