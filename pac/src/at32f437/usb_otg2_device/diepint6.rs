...
pub type R = crate::R<Diepint6Spec>;
#[doc = "Register `DIEPINT6` writer"]
pub type W = crate::W<Diepint6Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn xferc(&mut self) -> XfercW<Diepint6Spec> {
        XfercW::new(self, 0)
    }
    #[doc = "Bit 1 - Endpoint disabled interrupt"]
    #[inline(always)]
    #[must_use]
    pub fn eptdisd(&mut self) -> EptdisdW<Diepint6Spec> {
        EptdisdW::new(self, 1)
    }
    #[doc = "Bit 3 - Timeout condition"]
    #[inline(always)]
    #[must_use]
    pub fn timeout(&mut self) -> TimeoutW<Diepint6Spec> {
        TimeoutW::new(self, 3)
    }
    #[doc = "Bit 4 - IN token received when TxFIFO is empty"]
    #[inline(always)]
    #[must_use]
    pub fn intkntxfemp(&mut self) -> IntkntxfempW<Diepint6Spec> {
        IntkntxfempW::new(self, 4)
    }
    #[doc = "Bit 6 - IN endpoint NAK effective"]
    #[inline(always)]
    #[must_use]
    pub fn ineptnak(&mut self) -> IneptnakW<Diepint6Spec> {
...
pub struct Diepint6Spec;
impl crate::RegisterSpec for Diepint6Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`diepint6::R`](R) reader structure"]
impl crate::Readable for Diepint6Spec {}
#[doc = "`write(|w| ..)` method takes [`diepint6::W`](W) writer structure"]
impl crate::Writable for Diepint6Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DIEPINT6 to value 0x80"]
impl crate::Resettable for Diepint6Spec {
