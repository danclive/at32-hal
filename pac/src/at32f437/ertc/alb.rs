#[doc = "Register `ALB` reader"]
pub type R = crate::R<AlbSpec>;
#[doc = "Register `ALB` writer"]
pub type W = crate::W<AlbSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn su(&mut self) -> SuW<AlbSpec> {
        SuW::new(self, 0)
    }
    #[doc = "Bits 4:6 - Second tens"]
    #[inline(always)]
    #[must_use]
    pub fn st(&mut self) -> StW<AlbSpec> {
        StW::new(self, 4)
    }
    #[doc = "Bit 7 - Seconds mask"]
    #[inline(always)]
    #[must_use]
    pub fn mask1(&mut self) -> Mask1W<AlbSpec> {
        Mask1W::new(self, 7)
    }
    #[doc = "Bits 8:11 - Minute units"]
    #[inline(always)]
    #[must_use]
    pub fn mu(&mut self) -> MuW<AlbSpec> {
        MuW::new(self, 8)
    }
    #[doc = "Bits 12:14 - Minute tens"]
    #[inline(always)]
    #[must_use]
    pub fn mt(&mut self) -> MtW<AlbSpec> {
        MtW::new(self, 12)
    }
    #[doc = "Bit 15 - Minutes mask"]
    #[inline(always)]
    #[must_use]
    pub fn mask2(&mut self) -> Mask2W<AlbSpec> {
        Mask2W::new(self, 15)
    }
    #[doc = "Bits 16:19 - Hour units"]
    #[inline(always)]
    #[must_use]
    pub fn hu(&mut self) -> HuW<AlbSpec> {
        HuW::new(self, 16)
    }
    #[doc = "Bits 20:21 - Hour tens"]
    #[inline(always)]
    #[must_use]
    pub fn ht(&mut self) -> HtW<AlbSpec> {
        HtW::new(self, 20)
    }
    #[doc = "Bit 22 - AM/PM"]
    #[inline(always)]
    #[must_use]
    pub fn ampm(&mut self) -> AmpmW<AlbSpec> {
        AmpmW::new(self, 22)
    }
    #[doc = "Bit 23 - Hours mask"]
    #[inline(always)]
    #[must_use]
    pub fn mask3(&mut self) -> Mask3W<AlbSpec> {
        Mask3W::new(self, 23)
    }
    #[doc = "Bits 24:27 - Date units"]
    #[inline(always)]
    #[must_use]
    pub fn du(&mut self) -> DuW<AlbSpec> {
        DuW::new(self, 24)
    }
    #[doc = "Bits 28:29 - Date tens"]
    #[inline(always)]
    #[must_use]
    pub fn dt(&mut self) -> DtW<AlbSpec> {
        DtW::new(self, 28)
    }
    #[doc = "Bit 30 - Date/week mode select"]
    #[inline(always)]
    #[must_use]
    pub fn wksel(&mut self) -> WkselW<AlbSpec> {
        WkselW::new(self, 30)
    }
    #[doc = "Bit 31 - Date/week mask"]
    #[inline(always)]
    #[must_use]
    pub fn mask4(&mut self) -> Mask4W<AlbSpec> {
        Mask4W::new(self, 31)
    }
}
#[doc = "Alarm B register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`alb::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`alb::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct AlbSpec;
impl crate::RegisterSpec for AlbSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`alb::R`](R) reader structure"]
impl crate::Readable for AlbSpec {}
#[doc = "`write(|w| ..)` method takes [`alb::W`](W) writer structure"]
impl crate::Writable for AlbSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets ALB to value 0"]
impl crate::Resettable for AlbSpec {
