...
pub type Cspt18R = crate::FieldReader;
#[doc = "Field `CSPT18` writer - Selection sample time of channel ADC_IN18"]
pub type Cspt18W<'a, REG> = crate::FieldWriter<'a, REG, 3>;
impl R {
    ...
    #[inline(always)]
    pub fn cspt18(&self) -> Cspt18R {
        Cspt18R::new(((self.bits >> 24) & 7) as u8)
    }
}
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("SPT1")
            .field("cspt18", &self.cspt18())
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cspt18(&mut self) -> Cspt18W<Spt1Spec> {
        Cspt18W::new(self, 24)
    }
}
