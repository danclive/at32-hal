...
pub type R = crate::R<Hcchar1Spec>;
#[doc = "Register `HCCHAR1` writer"]
pub type W = crate::W<Hcchar1Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn mps(&mut self) -> MpsW<Hcchar1Spec> {
        MpsW::new(self, 0)
    }
    #[doc = "Bits 11:14 - Endpoint number"]
    #[inline(always)]
    #[must_use]
    pub fn eptnum(&mut self) -> EptnumW<Hcchar1Spec> {
        EptnumW::new(self, 11)
    }
    #[doc = "Bit 15 - Endpoint direction"]
    #[inline(always)]
    #[must_use]
    pub fn eptdir(&mut self) -> EptdirW<Hcchar1Spec> {
        EptdirW::new(self, 15)
    }
    #[doc = "Bit 17 - Low-speed device"]
    #[inline(always)]
    #[must_use]
    pub fn lspddev(&mut self) -> LspddevW<Hcchar1Spec> {
        LspddevW::new(self, 17)
    }
    #[doc = "Bits 18:19 - Endpoint type"]
    #[inline(always)]
    #[must_use]
    pub fn eptype(&mut self) -> EptypeW<Hcchar1Spec> {
        EptypeW::new(self, 18)
    }
    #[doc = "Bits 20:21 - Multicount"]
    #[inline(always)]
    #[must_use]
    pub fn mc(&mut self) -> McW<Hcchar1Spec> {
        McW::new(self, 20)
    }
    #[doc = "Bits 22:28 - Device address"]
    #[inline(always)]
    #[must_use]
    pub fn devaddr(&mut self) -> DevaddrW<Hcchar1Spec> {
        DevaddrW::new(self, 22)
    }
    #[doc = "Bit 29 - Odd frame"]
    #[inline(always)]
    #[must_use]
    pub fn oddfrm(&mut self) -> OddfrmW<Hcchar1Spec> {
        OddfrmW::new(self, 29)
    }
    #[doc = "Bit 30 - Channel disable"]
    #[inline(always)]
    #[must_use]
    pub fn chdis(&mut self) -> ChdisW<Hcchar1Spec> {
        ChdisW::new(self, 30)
    }
    #[doc = "Bit 31 - Channel enable"]
    #[inline(always)]
    #[must_use]
    pub fn chena(&mut self) -> ChenaW<Hcchar1Spec> {
        ChenaW::new(self, 31)
    }
}
...
pub struct Hcchar1Spec;
impl crate::RegisterSpec for Hcchar1Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`hcchar1::R`](R) reader structure"]
impl crate::Readable for Hcchar1Spec {}
#[doc = "`write(|w| ..)` method takes [`hcchar1::W`](W) writer structure"]
impl crate::Writable for Hcchar1Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets HCCHAR1 to value 0"]
impl crate::Resettable for Hcchar1Spec {
