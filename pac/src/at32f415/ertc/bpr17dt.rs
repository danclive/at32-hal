...
pub type R = crate::R<Bpr17dtSpec>;
#[doc = "Register `BPR17DT` writer"]
pub type W = crate::W<Bpr17dtSpec>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("BPR17DT").field("dt", &self.dt()).finish()
    }
}
impl W {
    #[doc = "Bits 0:31 - Battery powered domain data"]
    #[inline(always)]
    #[must_use]
    pub fn dt(&mut self) -> DtW<Bpr17dtSpec> {
        DtW::new(self, 0)
    }
}
...
pub struct Bpr17dtSpec;
impl crate::RegisterSpec for Bpr17dtSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`bpr17dt::R`](R) reader structure"]
impl crate::Readable for Bpr17dtSpec {}
#[doc = "`write(|w| ..)` method takes [`bpr17dt::W`](W) writer structure"]
impl crate::Writable for Bpr17dtSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets BPR17DT to value 0"]
impl crate::Resettable for Bpr17dtSpec {
