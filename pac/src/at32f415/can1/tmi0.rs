...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tmsr(&mut self) -> TmsrW<Tmi0Spec> {
        TmsrW::new(self, 0)
    }
    #[doc = "Bit 1 - Transmit mailbox frame type select"]
    #[inline(always)]
    #[must_use]
    pub fn tmfrsel(&mut self) -> TmfrselW<Tmi0Spec> {
        TmfrselW::new(self, 1)
    }
    #[doc = "Bit 2 - Transmit mailbox identifier type select"]
    #[inline(always)]
    #[must_use]
    pub fn tmidsel(&mut self) -> TmidselW<Tmi0Spec> {
        TmidselW::new(self, 2)
    }
    #[doc = "Bits 3:20 - Ttransmit mailbox extended identifier"]
    #[inline(always)]
    #[must_use]
    pub fn tmeid(&mut self) -> TmeidW<Tmi0Spec> {
        TmeidW::new(self, 3)
    }
    #[doc = "Bits 21:31 - Transmit mailbox standard identifier or extended identifier high bytes"]
    #[inline(always)]
    #[must_use]
    pub fn tmsid(&mut self) -> TmsidW<Tmi0Spec> {
        TmsidW::new(self, 21)
    }
}
