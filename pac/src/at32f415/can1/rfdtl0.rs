#[doc = "Register `RFDTL0` reader"]
pub type R = crate::R<Rfdtl0Spec>;
...
#[doc = "Receive FIFO 0 low byte data register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`rfdtl0::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Rfdtl0Spec;
impl crate::RegisterSpec for Rfdtl0Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`rfdtl0::R`](R) reader structure"]
impl crate::Readable for Rfdtl0Spec {}
#[doc = "`reset()` method sets RFDTL0 to value 0"]
impl crate::Resettable for Rfdtl0Spec {
