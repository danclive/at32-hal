...
pub struct Rfdth1Spec;
impl crate::RegisterSpec for Rfdth1Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`rfdth1::R`](R) reader structure"]
impl crate::Readable for Rfdth1Spec {}
#[doc = "`reset()` method sets RFDTH1 to value 0"]
impl crate::Resettable for Rfdth1Spec {
