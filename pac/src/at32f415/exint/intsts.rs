...
#[doc = "Field `LINE20` reader - Line 20 state bit"]
pub type Line20R = crate::BitReader;
#[doc = "Field `LINE20` writer - Line 20 state bit"]
pub type Line20W<'a, REG> = crate::BitWriter<'a, REG>;
...
#[doc = "Field `LINE22` reader - Line 22 state bit"]
pub type Line22R = crate::BitReader;
#[doc = "Field `LINE22` writer - Line 22 state bit"]
pub type Line22W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn line19(&mut self) -> Line19W<IntstsSpec> {
        Line19W::new(self, 19)
    }
    #[doc = "Bit 20 - Line 20 state bit"]
    #[inline(always)]
    #[must_use]
    pub fn line20(&mut self) -> Line20W<IntstsSpec> {
        Line20W::new(self, 20)
    }
    #[doc = "Bit 21 - Line 21 state bit"]
    #[inline(always)]
    #[must_use]
    pub fn line21(&mut self) -> Line21W<IntstsSpec> {
        Line21W::new(self, 21)
    }
    #[doc = "Bit 22 - Line 22 state bit"]
    #[inline(always)]
    #[must_use]
    pub fn line22(&mut self) -> Line22W<IntstsSpec> {
        Line22W::new(self, 22)
    }
}
