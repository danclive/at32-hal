...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn chen(&mut self) -> ChenW<C4ctrlSpec> {
        ChenW::new(self, 0)
    }
    #[doc = "Bit 1 - Full data transfer interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn fdtien(&mut self) -> FdtienW<C4ctrlSpec> {
        FdtienW::new(self, 1)
    }
    #[doc = "Bit 2 - Half data transfer interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn hdtien(&mut self) -> HdtienW<C4ctrlSpec> {
        HdtienW::new(self, 2)
    }
    #[doc = "Bit 3 - Data transfer error interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn dterrien(&mut self) -> DterrienW<C4ctrlSpec> {
        DterrienW::new(self, 3)
    }
    #[doc = "Bit 4 - Data transfer direction"]
    #[inline(always)]
    #[must_use]
    pub fn dtd(&mut self) -> DtdW<C4ctrlSpec> {
        DtdW::new(self, 4)
    }
    #[doc = "Bit 5 - Loop mode"]
    #[inline(always)]
    #[must_use]
    pub fn lm(&mut self) -> LmW<C4ctrlSpec> {
        LmW::new(self, 5)
    }
    #[doc = "Bit 6 - Peripheral address increment mode"]
    #[inline(always)]
    #[must_use]
    pub fn pincm(&mut self) -> PincmW<C4ctrlSpec> {
        PincmW::new(self, 6)
    }
    #[doc = "Bit 7 - Memory address increment mode"]
    #[inline(always)]
    #[must_use]
    pub fn mincm(&mut self) -> MincmW<C4ctrlSpec> {
        MincmW::new(self, 7)
    }
    #[doc = "Bits 8:9 - Peripheral data bit width"]
    #[inline(always)]
    #[must_use]
    pub fn pwidth(&mut self) -> PwidthW<C4ctrlSpec> {
        PwidthW::new(self, 8)
    }
    #[doc = "Bits 10:11 - Memory data bit width"]
    #[inline(always)]
    #[must_use]
    pub fn mwidth(&mut self) -> MwidthW<C4ctrlSpec> {
        MwidthW::new(self, 10)
    }
    #[doc = "Bits 12:13 - Channel Priority level"]
    #[inline(always)]
    #[must_use]
    pub fn chpl(&mut self) -> ChplW<C4ctrlSpec> {
        ChplW::new(self, 12)
    }
    #[doc = "Bit 14 - Memory to memory mode"]
    #[inline(always)]
    #[must_use]
    pub fn m2m(&mut self) -> M2mW<C4ctrlSpec> {
        M2mW::new(self, 14)
    }
}
#[doc = "DMA channel configuration register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`c4ctrl::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`c4ctrl::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
