#[doc = "Register `TMDTH0` reader"]
pub type R = crate::R<Tmdth0Spec>;
#[doc = "Register `TMDTH0` writer"]
pub type W = crate::W<Tmdth0Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tmdt4(&mut self) -> Tmdt4W<Tmdth0Spec> {
        Tmdt4W::new(self, 0)
    }
    #[doc = "Bits 8:15 - Transmit mailbox data byte 5"]
    #[inline(always)]
    #[must_use]
    pub fn tmdt5(&mut self) -> Tmdt5W<Tmdth0Spec> {
        Tmdt5W::new(self, 8)
    }
    #[doc = "Bits 16:23 - Transmit mailbox data byte 6"]
    #[inline(always)]
    #[must_use]
    pub fn tmdt6(&mut self) -> Tmdt6W<Tmdth0Spec> {
        Tmdt6W::new(self, 16)
    }
    #[doc = "Bits 24:31 - Transmit mailbox data byte 7"]
    #[inline(always)]
    #[must_use]
    pub fn tmdt7(&mut self) -> Tmdt7W<Tmdth0Spec> {
        Tmdt7W::new(self, 24)
    }
}
#[doc = "Transmit mailbox 0 high byte data register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`tmdth0::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`tmdth0::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Tmdth0Spec;
impl crate::RegisterSpec for Tmdth0Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`tmdth0::R`](R) reader structure"]
impl crate::Readable for Tmdth0Spec {}
#[doc = "`write(|w| ..)` method takes [`tmdth0::W`](W) writer structure"]
impl crate::Writable for Tmdth0Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets TMDTH0 to value 0"]
impl crate::Resettable for Tmdth0Spec {
