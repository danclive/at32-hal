#[doc = "Register `EPT0` reader"]
pub type R = crate::R<Ept0Spec>;
#[doc = "Register `EPT0` writer"]
pub type W = crate::W<Ept0Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn eptaddr(&mut self) -> EptaddrW<Ept0Spec> {
        EptaddrW::new(self, 0)
    }
    #[doc = "Bits 4:5 - Tx status"]
    #[inline(always)]
    #[must_use]
    pub fn txsts(&mut self) -> TxstsW<Ept0Spec> {
        TxstsW::new(self, 4)
    }
    #[doc = "Bit 6 - Tx data toggle synchronization"]
    #[inline(always)]
    #[must_use]
    pub fn txdts(&mut self) -> TxdtsW<Ept0Spec> {
        TxdtsW::new(self, 6)
    }
    #[doc = "Bit 7 - Tx transaction completed"]
    #[inline(always)]
    #[must_use]
    pub fn txtc(&mut self) -> TxtcW<Ept0Spec> {
        TxtcW::new(self, 7)
    }
    #[doc = "Bit 8 - Endpoint extend function"]
    #[inline(always)]
    #[must_use]
    pub fn exf(&mut self) -> ExfW<Ept0Spec> {
        ExfW::new(self, 8)
    }
    #[doc = "Bits 9:10 - Transfer type"]
    #[inline(always)]
    #[must_use]
    pub fn trans_type(&mut self) -> TransTypeW<Ept0Spec> {
        TransTypeW::new(self, 9)
    }
    #[doc = "Bit 11 - Setup transaction completed"]
    #[inline(always)]
    #[must_use]
    pub fn setuptc(&mut self) -> SetuptcW<Ept0Spec> {
        SetuptcW::new(self, 11)
    }
    #[doc = "Bits 12:13 - Rx Status"]
    #[inline(always)]
    #[must_use]
    pub fn rxsts(&mut self) -> RxstsW<Ept0Spec> {
        RxstsW::new(self, 12)
    }
    #[doc = "Bit 14 - Rx data toggle synchronization"]
    #[inline(always)]
    #[must_use]
    pub fn rxdts(&mut self) -> RxdtsW<Ept0Spec> {
        RxdtsW::new(self, 14)
    }
    #[doc = "Bit 15 - Rx transaction completed"]
    #[inline(always)]
    #[must_use]
    pub fn rxtc(&mut self) -> RxtcW<Ept0Spec> {
        RxtcW::new(self, 15)
    }
}
#[doc = "endpoint 0 register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ept0::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ept0::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Ept0Spec;
impl crate::RegisterSpec for Ept0Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ept0::R`](R) reader structure"]
impl crate::Readable for Ept0Spec {}
#[doc = "`write(|w| ..)` method takes [`ept0::W`](W) writer structure"]
impl crate::Writable for Ept0Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets EPT0 to value 0"]
impl crate::Resettable for Ept0Spec {
