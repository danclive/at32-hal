#[doc = "Register `EPT1` reader"]
pub type R = crate::R<Ept1Spec>;
#[doc = "Register `EPT1` writer"]
pub type W = crate::W<Ept1Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn eptaddr(&mut self) -> EptaddrW<Ept1Spec> {
        EptaddrW::new(self, 0)
    }
    #[doc = "Bits 4:5 - Tx status"]
    #[inline(always)]
    #[must_use]
    pub fn txsts(&mut self) -> TxstsW<Ept1Spec> {
        TxstsW::new(self, 4)
    }
    #[doc = "Bit 6 - Tx data toggle synchronization"]
    #[inline(always)]
    #[must_use]
    pub fn txdts(&mut self) -> TxdtsW<Ept1Spec> {
        TxdtsW::new(self, 6)
    }
    #[doc = "Bit 7 - Tx transaction completed"]
    #[inline(always)]
    #[must_use]
    pub fn txtc(&mut self) -> TxtcW<Ept1Spec> {
        TxtcW::new(self, 7)
    }
    #[doc = "Bit 8 - Endpoint extend function"]
    #[inline(always)]
    #[must_use]
    pub fn exf(&mut self) -> ExfW<Ept1Spec> {
        ExfW::new(self, 8)
    }
    #[doc = "Bits 9:10 - Transfer type"]
    #[inline(always)]
    #[must_use]
    pub fn trans_type(&mut self) -> TransTypeW<Ept1Spec> {
        TransTypeW::new(self, 9)
    }
    #[doc = "Bit 11 - Setup transaction completed"]
    #[inline(always)]
    #[must_use]
    pub fn setuptc(&mut self) -> SetuptcW<Ept1Spec> {
        SetuptcW::new(self, 11)
    }
    #[doc = "Bits 12:13 - Rx Status"]
    #[inline(always)]
    #[must_use]
    pub fn rxsts(&mut self) -> RxstsW<Ept1Spec> {
        RxstsW::new(self, 12)
    }
    #[doc = "Bit 14 - Rx data toggle synchronization"]
    #[inline(always)]
    #[must_use]
    pub fn rxdts(&mut self) -> RxdtsW<Ept1Spec> {
        RxdtsW::new(self, 14)
    }
    #[doc = "Bit 15 - Rx transaction completed"]
    #[inline(always)]
    #[must_use]
    pub fn rxtc(&mut self) -> RxtcW<Ept1Spec> {
        RxtcW::new(self, 15)
    }
}
...
pub struct Ept1Spec;
impl crate::RegisterSpec for Ept1Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ept1::R`](R) reader structure"]
impl crate::Readable for Ept1Spec {}
#[doc = "`write(|w| ..)` method takes [`ept1::W`](W) writer structure"]
impl crate::Writable for Ept1Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets EPT1 to value 0"]
impl crate::Resettable for Ept1Spec {
