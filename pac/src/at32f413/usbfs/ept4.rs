...
pub type R = crate::R<Ept4Spec>;
#[doc = "Register `EPT4` writer"]
pub type W = crate::W<Ept4Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn eptaddr(&mut self) -> EptaddrW<Ept4Spec> {
        EptaddrW::new(self, 0)
    }
    #[doc = "Bits 4:5 - Tx status"]
    #[inline(always)]
    #[must_use]
    pub fn txsts(&mut self) -> TxstsW<Ept4Spec> {
        TxstsW::new(self, 4)
    }
    #[doc = "Bit 6 - Tx data toggle synchronization"]
    #[inline(always)]
    #[must_use]
    pub fn txdts(&mut self) -> TxdtsW<Ept4Spec> {
        TxdtsW::new(self, 6)
    }
    #[doc = "Bit 7 - Tx transaction completed"]
    #[inline(always)]
    #[must_use]
    pub fn txtc(&mut self) -> TxtcW<Ept4Spec> {
        TxtcW::new(self, 7)
    }
    #[doc = "Bit 8 - Endpoint extend function"]
    #[inline(always)]
    #[must_use]
    pub fn exf(&mut self) -> ExfW<Ept4Spec> {
        ExfW::new(self, 8)
    }
    #[doc = "Bits 9:10 - Transfer type"]
    #[inline(always)]
    #[must_use]
    pub fn trans_type(&mut self) -> TransTypeW<Ept4Spec> {
        TransTypeW::new(self, 9)
    }
    #[doc = "Bit 11 - Setup transaction completed"]
    #[inline(always)]
    #[must_use]
    pub fn setuptc(&mut self) -> SetuptcW<Ept4Spec> {
        SetuptcW::new(self, 11)
    }
    #[doc = "Bits 12:13 - Rx Status"]
    #[inline(always)]
    #[must_use]
    pub fn rxsts(&mut self) -> RxstsW<Ept4Spec> {
        RxstsW::new(self, 12)
    }
    #[doc = "Bit 14 - Rx data toggle synchronization"]
    #[inline(always)]
    #[must_use]
    pub fn rxdts(&mut self) -> RxdtsW<Ept4Spec> {
        RxdtsW::new(self, 14)
    }
    #[doc = "Bit 15 - Rx transaction completed"]
    #[inline(always)]
    #[must_use]
    pub fn rxtc(&mut self) -> RxtcW<Ept4Spec> {
        RxtcW::new(self, 15)
    }
}
