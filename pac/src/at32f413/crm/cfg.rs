...
pub type PllrangeR = crate::BitReader;
#[doc = "Field `PLLRANGE` writer - PLL clock output frequency up 72MHz or not"]
pub type PllrangeW<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ...
    #[inline(always)]
    pub fn pllrange(&self) -> PllrangeR {
        PllrangeR::new(((self.bits >> 31) & 1) != 0)
    }
}
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pllrange(&mut self) -> PllrangeW<CfgSpec> {
        PllrangeW::new(self, 31)
    }
}
